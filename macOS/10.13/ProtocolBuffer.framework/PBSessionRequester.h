...
@property (nonatomic, readwrite, retain) NSArray *clientCertificates;
@property (nonatomic, readwrite, retain) NSURLSessionTask *currentTask;
@property (atomic, readonly, copy) NSString *debugDescription;
@property (atomic, readonly) <PBSessionRequesterDelegate> *delegate;
@property (atomic, readonly, copy) NSString *description;
@property (nonatomic, readonly) unsigned long long downloadPayloadSize;
@property (atomic, readonly) unsigned long long hash;
@property (nonatomic, readwrite, copy) NSDictionary *httpRequestHeaders;
@property (nonatomic, readwrite, retain) NSDictionary *httpResponseHeaders;
@property (nonatomic, readwrite) BOOL ignoresResponse;
@property (nonatomic, readwrite, retain) NSString *logRequestToFile;
@property (nonatomic, readwrite, retain) NSString *logResponseToFile;
@property (atomic, readwrite) BOOL needsCancel;
...
@property (nonatomic, readwrite) BOOL shouldHandleCookies;
@property (atomic, readonly) Class superclass;
@property (nonatomic, readwrite) double timeoutSeconds;
