...
@property (setter=_setBehavesAsRingtonePicker:, nonatomic, readwrite) BOOL _behavesAsRingtonePicker;
@property (setter=_setClassicAlertToneIdentifiers:, nonatomic, readwrite, retain) NSArray *_classicAlertToneIdentifiers;
@property (setter=_setClassicRingtoneIdentifiers:, nonatomic, readwrite, retain) NSArray *_classicRingtoneIdentifiers;
...
@property (setter=_setSelectedClassicAlertToneIndex:, nonatomic, readwrite) unsigned long long _selectedClassicAlertToneIndex;
@property (setter=_setSelectedClassicRingtoneIndex:, nonatomic, readwrite) unsigned long long _selectedClassicRingtoneIndex;
@property (setter=_setSelectedToneIndexPath:, nonatomic, readwrite, retain) NSIndexPath *_selectedToneIndexPath;
@property (setter=_setToneManager:, nonatomic, readwrite, retain) TLToneManager *_toneManager;
...
@property (nonatomic, readwrite) <TKTonePickerControllerDelegate> *delegate;
@property (atomic, readonly, copy) NSString *description;
@property (atomic, readonly) unsigned long long hash;
@property (nonatomic, readwrite) BOOL ignoreMute;
@property (nonatomic, readonly) NSIndexPath *indexPathForSelectedTone;
@property (getter=isMediaAtTop, nonatomic, readwrite) BOOL mediaAtTop;
@property (getter=isNoneAtTop, nonatomic, readwrite) BOOL noneAtTop;
@property (nonatomic, readwrite, copy) NSString *noneString;
...
@property (nonatomic, readwrite, copy) NSString *selectedVibrationIdentifier;
@property (nonatomic, readwrite) BOOL showsDefault;
@property (nonatomic, readwrite) BOOL showsIgnoreMute;
@property (nonatomic, readwrite) BOOL showsNone;
@property (nonatomic, readwrite) BOOL showsNothingSelected;
@property (nonatomic, readwrite) BOOL showsToneStore;
@property (nonatomic, readwrite) BOOL showsVibrations;
@property (atomic, readonly) Class superclass;
@property (nonatomic, readwrite, retain) <TLToneStoreDownloadController> *toneStoreDownloadController;
