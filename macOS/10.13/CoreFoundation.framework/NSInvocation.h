...
+ (id)_mapkit_invocationWithSelector:(SEL)arg1 target:(id)arg2 arguments:(struct __va_list_tag { unsigned int x1; unsigned int x2; void *x3; void *x4; })arg3;

// Image: /System/Library/Frameworks/MediaPlayer.framework/Versions/A/MediaPlayer

// NSInvocation (MPInvocationCustomMemoryManagement)
