...
+ (id)__new:(const id*)arg1 :(const id*)arg2 :(struct __va_list_tag { unsigned int x1; unsigned int x2; void *x3; void *x4; })arg3 :(unsigned long long)arg4 :(BOOL)arg5 :(BOOL)arg6;
