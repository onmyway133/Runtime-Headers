...
@property (atomic, readonly) void*key;
@property (atomic, readonly) _CFXNotificationRegistrationContainer *parent;
@property (atomic, readonly) _CFXNotificationRegistrar *registrar;
