...
@property (nonatomic, readwrite) BOOL conservativeEntry;
@property (nonatomic, readonly, copy) NSString *identifier;
@property (nonatomic, readwrite) BOOL notifyOnEntry;
@property (nonatomic, readwrite) BOOL notifyOnExit;
@property (nonatomic, readwrite, copy) NSString *onBehalfOfBundleId;
