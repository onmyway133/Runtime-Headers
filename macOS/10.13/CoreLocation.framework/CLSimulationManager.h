...
@property (nonatomic, readwrite) int locationDeliveryBehavior;
@property (nonatomic, readwrite) double locationDistance;
@property (nonatomic, readwrite) double locationInterval;
@property (nonatomic, readwrite) int locationRepeatBehavior;
@property (nonatomic, readwrite) double locationSpeed;
