...
- (void)geocodeAddressDictionary:(id)arg1 preferredLocale:(id)arg2 completionHandler:(id)arg3;
...
- (void)geocodeAddressString:(id)arg1 inRegion:(id)arg2 preferredLocale:(id)arg3 completionHandler:(id)arg4;
- (void)geocodePostalAddress:(id)arg1 completionHandler:(id)arg2;
- (void)geocodePostalAddress:(id)arg1 preferredLocale:(id)arg2 completionHandler:(id)arg3;
- (id)init;
- (BOOL)isGeocoding;
...
- (void)reverseGeocodeLocation:(id)arg1 preferredLocale:(id)arg2 completionHandler:(id)arg3;
- (void)reverseGeocodeLocation:(id)arg1 preferredLocale:(id)arg2 heading:(double)arg3 localResultsOnly:(BOOL)arg4 completionHandler:(id)arg5;
