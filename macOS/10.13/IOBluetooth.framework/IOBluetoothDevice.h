...
@property (atomic, readonly) IOBluetoothSDPServiceRecord *WIAPSinkServiceRecord;
...
@property (atomic, readonly) BOOL isANCSupported;
...
@property (nonatomic, readwrite) BOOL isDevFused;
@property (atomic, readonly) BOOL isEnhancedDoubleTapSupported;
...
@property (atomic, readonly) BOOL isWIAPSink;
@property (atomic, readwrite, retain) NSDate *lastNameUpdate;
@property (nonatomic, readwrite) unsigned char leftDoubleTap;
@property (nonatomic, readonly) unsigned char linkLevelEncryption;
@property (nonatomic, readwrite) unsigned char listeningMode;
...
@property (getter=isLowEnergyKeyboard, nonatomic, readwrite) BOOL lowEnergyKeyboard;
@property (getter=isLowEnergyPointer, nonatomic, readwrite) BOOL lowEnergyPointer;
...
@property (nonatomic, readwrite) unsigned char rightDoubleTap;
...
- (BOOL)isLowEnergyKeyboard;
- (BOOL)isLowEnergyPointer;
- (BOOL)isMCPaired;
- (BOOL)isMac;
...
- (void)setLowEnergyKeyboard:(BOOL)arg1;
- (void)setLowEnergyPointer:(BOOL)arg1;
...
- (BOOL)isAudioSink;
- (BOOL)isEnhancedDoubleTapSupported;
