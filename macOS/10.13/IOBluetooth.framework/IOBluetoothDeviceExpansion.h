...
@property (atomic, readwrite) BOOL isDevFused;
@property (atomic, readwrite) unsigned char leftDoubleTap;
@property (atomic, readwrite) unsigned char listeningMode;
...
@property (atomic, readwrite) BOOL lowEnergyKeyboard;
@property (atomic, readwrite) BOOL lowEnergyPointer;
@property (atomic, readwrite, retain) id mTarget;
...
@property (atomic, readwrite) unsigned char rightDoubleTap;
