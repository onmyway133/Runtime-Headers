...
@property (atomic, readonly, copy) NSString *fileName;
@property (atomic, readonly) int firstColumn;
@property (atomic, readonly) int firstLine;
@property (atomic, readonly) int lastColumn;
@property (atomic, readonly) int lastLine;
