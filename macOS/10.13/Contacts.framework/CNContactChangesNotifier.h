...
@property (getter=isObservingNotification, nonatomic, readwrite) BOOL observingNotification;
...
- (void)registerObserver:(id)arg1 forContact:(id)arg2 keysToFetch:(id)arg3 completionHandler:(id)arg4;
...
- (void)unregisterObserver:(id)arg1 forContact:(id)arg2 completionHandler:(id)arg3;
- (id)workQueue;
