...
@property (nonatomic, readwrite) BOOL emphasizesPrimaryNameComponent;
@property (nonatomic, readwrite) unsigned long long fallbackStyle;
@property (nonatomic, readwrite) BOOL ignoresNickname;
@property (nonatomic, readwrite) BOOL ignoresOrganization;
@property (atomic, readonly, retain) NSPersonNameComponentsFormatter *nameFormatter;
@property (nonatomic, readwrite) long long sortOrder;
...
// CNContactFormatter (Suggestions)
