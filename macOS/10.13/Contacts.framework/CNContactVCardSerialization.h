...
+ (void)contactsWithData:(id)arg1 completionHandler:(id)arg2;
+ (id)contactsWithData:(id)arg1 error:(id*)arg2;
+ (void)contactsWithData:(id)arg1 scheduler:(id)arg2 completionHandler:(id)arg3;
+ (id)dataWithContacts:(id)arg1 error:(id*)arg2;
+ (void)dataWithContacts:(id)arg1 options:(id)arg2 completionHandler:(id)arg3;
...
+ (void)dataWithContacts:(id)arg1 options:(id)arg2 scheduler:(id)arg3 completionHandler:(id)arg4;
+ (id)descriptorForRequiredKeys;
+ (id)descriptorForRequiredKeysWithOptions:(id)arg1;
+ (id)descriptorForRequiredKeysWithOptions:(id)arg1 description:(id)arg2;

// CNContactVCardSerialization (MECARD)
