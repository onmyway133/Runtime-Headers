...
@property (nonatomic, readwrite) BOOL allowTempLogStorage;
@property (nonatomic, readonly) PFUbiquityLocation *currentRootLocation;
@property (atomic, readwrite, retain) NSDate *lastTransactionDate;
...
@property (nonatomic, readwrite) BOOL throwOptimisticLockingException;
@property (nonatomic, readwrite, retain) PFUbiquityLocation *ubiquityRootLocation;
@property (nonatomic, readwrite) BOOL useLocalStorage;
