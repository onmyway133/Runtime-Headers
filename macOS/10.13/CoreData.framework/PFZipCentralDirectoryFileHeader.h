...
@property (nonatomic, readwrite) unsigned int compressedSize;
@property (nonatomic, readwrite) unsigned short compressionMethod;
@property (nonatomic, readwrite) unsigned int crc32;
@property (nonatomic, readwrite) unsigned int externalFileAttrs;
@property (nonatomic, readwrite, retain) NSData *extraFieldData;
@property (nonatomic, readonly) unsigned short extraFieldLength;
@property (nonatomic, readwrite, retain) NSString *fileComment;
@property (nonatomic, readonly) unsigned short fileCommentLength;
@property (nonatomic, readwrite) unsigned short fileStartDiskNumber;
@property (nonatomic, readwrite, retain) NSString *filename;
@property (nonatomic, readonly) unsigned short filenameLength;
@property (nonatomic, readwrite) unsigned short generalPurposeBit;
@property (nonatomic, readwrite) unsigned short internalFileAttrs;
@property (nonatomic, readwrite) unsigned short lastModDate;
@property (nonatomic, readwrite) unsigned short lastModTime;
@property (nonatomic, readwrite) unsigned int localFileHeaderRelativeOffset;
@property (nonatomic, readwrite) unsigned int uncompressedSize;
@property (nonatomic, readwrite) unsigned short versionMadeBy;
@property (nonatomic, readwrite) unsigned short versionNeededToExtract;
