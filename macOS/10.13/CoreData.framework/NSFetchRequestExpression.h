...
@property (atomic, readonly) NSExpression *contextExpression;
@property (getter=isCountOnlyRequest, atomic, readonly) BOOL countOnlyRequest;
@property (atomic, readonly) NSExpression *requestExpression;
