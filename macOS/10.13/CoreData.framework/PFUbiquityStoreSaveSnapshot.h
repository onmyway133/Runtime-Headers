...
@property (nonatomic, readwrite, retain) PFUbiquityGlobalObjectIDCache *globalObjectIDCache;
...
@property (nonatomic, readwrite, retain) NSString *localPeerID;
...
@property (nonatomic, readwrite, retain) PFUbiquityKnowledgeVector *storeKV;
