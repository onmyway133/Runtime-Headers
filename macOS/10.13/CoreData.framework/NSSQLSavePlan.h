...
@property (atomic, readonly) <_NSCoreDataCollectionWithoutKeys> *externalDataReferencesToDelete;
@property (atomic, readonly) <_NSCoreDataCollectionWithoutKeys> *externalDataReferencesToSave;
@property (atomic, readonly) NSSaveChangesRequest *saveRequest;
@property (atomic, readonly) NSManagedObjectContext *savingContext;
@property (nonatomic, readwrite) int transactionInMemorySequence;
