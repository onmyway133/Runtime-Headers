...
@property (nonatomic, readwrite, retain) NSSQLiteStatement *fetchStatement;
@property (nonatomic, readonly) int fileProtectionLevel;
@property (nonatomic, readwrite) BOOL isFaultRequest;
@property (nonatomic, readwrite) BOOL isUsingCachedStatement;
...
@property (nonatomic, readwrite, retain) NSDictionary *prefetchingSubstitutionVariables;
