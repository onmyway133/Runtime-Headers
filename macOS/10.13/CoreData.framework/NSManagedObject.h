...
@property (atomic, readonly) NSString *_abcd_accountIdentifier;
...
// NSManagedObject (ABCDAdditions)

- (BOOL)abHasAddressBookContent;

// NSManagedObject (ABXMLAdditions)
...
// NSManagedObject (ABCDUtils)

- (id)_abcd_accountIdentifier;
