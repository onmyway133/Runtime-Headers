...
- (void)dealloc;
- (void)exportIfNecessaryInTransaction:(id)arg1 completion:(id)arg2;
- (void)exportOperationForHistoryToken:(id)arg1 finishedWithSavedRecords:(id)arg2 deletedRecordIDs:(id)arg3 operationError:(id)arg4 completion:(id)arg5;
...
- (void)processRecordsToSave:(id)arg1 andRecordIDsToDelete:(id)arg2 inTransaction:(id)arg3 historyTransactionID:(id)arg4 completion:(id)arg5;
- (id)request;
