...
- (id)database;
- (void)dealloc;
- (void)importIfNecessaryInTransaction:(id)arg1 completion:(id)arg2;
- (id)importOperation;
- (id)init;
- (id)initWithOptions:(id)arg1 request:(id)arg2 store:(id)arg3 workQueue:(id)arg4 zone:(id)arg5 andDatabase:(id)arg6;
- (id)monitor;
- (id)options;
- (void)processAccumulatedChangesForServerChangeToken:(id)arg1 withAccumulatedUpdates:(id)arg2 andDeletes:(id)arg3 inTransaction:(id)arg4 completion:(id)arg5;
