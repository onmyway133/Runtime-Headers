...
@property (nonatomic, readwrite) BOOL shouldPerformSecureOperation;
@property (nonatomic, readwrite) BOOL shouldRefreshAfterSave;
@property (atomic, readwrite) double stalenessInterval;
@property (atomic, readwrite, copy) NSString *transactionAuthor;
...
// NSManagedObjectContext (ABUpdatesAdditions)
