...
@property (nonatomic, readwrite) GVGraph *graph;
@property (nonatomic, readwrite, retain) NSMutableArray *ranks;
@property (nonatomic, readwrite, retain) NSMutableArray *selfEdges;
@property (nonatomic, readwrite) struct CGSize { double x1; double x2; } separation;
