...
@property (nonatomic, readwrite) <VKTileProviderClient> *client;
@property (nonatomic, readwrite) double contentScale;
@property (atomic, readonly, copy) NSString *debugDescription;
@property (nonatomic, readwrite, retain) <VKMapLayer> *debugLayer;
@property (nonatomic, readonly) GEOTileKeyList *debugLayerKeys;
@property (atomic, readonly, copy) NSString *description;
@property (nonatomic, readwrite) unsigned char fallbackFunction;
...
@property (getter=isPrefetchEnabled, nonatomic, readwrite) BOOL prefetchEnabled;
...
@property (nonatomic, readwrite) BOOL useStableFallback;
