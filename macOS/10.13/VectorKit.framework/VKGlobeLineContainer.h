...
@property (nonatomic, readwrite) <VKGlobeLineContainerDelegate> *delegate;
@property (atomic, readonly, copy) NSString *description;
@property (atomic, readonly) unsigned long long hash;
@property (nonatomic, readwrite, retain) <VKRouteMatchedAnnotationPresentation> *routeLineSplitAnnotation;
