...
@property (nonatomic, readwrite) /* Warning: unhandled struct encoding: '{VKCameraState={RigidTransform<double>={Quaternion<double>={Matrix<double' */ struct  cameraState; /* unknown property attribute:  1>=[3d]}}ddd} */
@property (nonatomic, readwrite) double canonicalPitch;
...
@property (nonatomic, readwrite) double fractionOfScreenAboveFarClipPlaneAtCanonicalPitch;
...
@property (nonatomic, readwrite) double maxHeight;
@property (nonatomic, readwrite) double maxHeightNoPitch;
@property (nonatomic, readwrite) double maxPitch;
@property (nonatomic, readwrite) double minHeight;
@property (nonatomic, readwrite) double ndcZNear;
@property (nonatomic, readonly) double nearClipDistance;
@property (nonatomic, readwrite) const /* Warning: unhandled struct encoding: '{Quaternion<double>={Matrix<double' */ struct *orientation; /* unknown property attribute:  1>=[3d]}d} */
@property (nonatomic, readonly) double pitch;
@property (nonatomic, readwrite) const /* Warning: unhandled struct encoding: '{Matrix<double' */ struct *position; /* unknown property attribute:  1>=[3d]} */
...
@property (nonatomic, readwrite) double terrainHeight;
...
@property (nonatomic, readwrite) float verticalFieldOfView;
