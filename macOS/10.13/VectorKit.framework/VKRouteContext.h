...
@property (nonatomic, readwrite, retain) NSString *accessPointEntryName;
@property (nonatomic, readwrite, retain) NSString *accessPointExitName;
@property (nonatomic, readwrite, retain) NSArray *alternateRoutes;
@property (nonatomic, readwrite) long long currentLegIndex;
@property (nonatomic, readwrite) long long currentStepIndex;
@property (nonatomic, readwrite) long long inspectedLegIndex;
@property (nonatomic, readwrite) long long inspectedStepIndex;
@property (nonatomic, readwrite, retain) NSString *locale;
@property (nonatomic, readwrite) struct { double x1; double x2; } puckLocation;
@property (nonatomic, readwrite) float puckRadius;
@property (nonatomic, readwrite) unsigned long long puckSnappedStopID;
...
@property (nonatomic, readwrite) BOOL snappingToTransitLines;
...
- (void)dealloc;
- (void)forEachSectionWithShareCount:(unsigned int)arg1 dothis:(id)arg2;
