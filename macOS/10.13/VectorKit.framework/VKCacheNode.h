...
@property (nonatomic, readwrite) struct VKCacheKey { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; } key;
@property (nonatomic, readwrite, retain) VKCacheNode *next;
@property (nonatomic, readwrite) VKCacheNode *previous;
