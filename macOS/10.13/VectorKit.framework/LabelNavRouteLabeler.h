...
@property (nonatomic, readwrite) /* Warning: unhandled struct encoding: '{VKLabelNavArtworkCache={unique_ptr<LRUCache<unsigned long' */ struct *artworkCache; /* unknown property attribute:  std::__1::hash<unsigned long> >}}}^{CGColor}^{CGColor}{VKGuidanceManeuverArrowMetrics={CGSize=dd}ddd{CGSize=dd}dddCddddddddddddddddBdddBB}} */
@property (nonatomic, readwrite, retain) NSString *currentLocationText;
@property (nonatomic, readwrite, retain) NSString *currentRoadName;
...
@property (nonatomic, readwrite, retain) NSString *currentShieldGroup;
@property (nonatomic, readwrite) BOOL debugDisableRoadSignLimit;
@property (nonatomic, readwrite) BOOL debugEnableShieldsOnRouteLine;
@property (nonatomic, readwrite) BOOL drawRoadSigns;
@property (nonatomic, readonly) BOOL needsLayout;
@property (nonatomic, readwrite, retain) VKPolylineOverlay *route;
