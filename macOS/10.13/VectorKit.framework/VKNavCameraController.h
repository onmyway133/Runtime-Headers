...
@property (nonatomic, readwrite) long long baseDisplayRate;
@property (nonatomic, readwrite) struct { double x1; double x2; } centerCoordinate;
@property (nonatomic, readwrite) struct VKEdgeInsets { float x1; float x2; float x3; float x4; } clientFramingInsets;
...
@property (nonatomic, readwrite) VKSceneConfiguration *sceneConfiguration;
@property (nonatomic, readwrite) VKScreenCanvas<VKInteractiveMap><VKMapDataAccess> *screenCanvas;
@property (atomic, readonly) Class superclass;
@property (nonatomic, readwrite) double zoomScale;
...
- (void)startWithPounce:(BOOL)arg1 startLocation:(struct { double x1; double x2; })arg2 startCourse:(double)arg3 pounceCompletionHandler:(id)arg4;
- (void)stop;
- (void)stopAnimations;
