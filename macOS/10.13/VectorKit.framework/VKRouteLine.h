...
@property (atomic, readwrite) BOOL hasNewRoadMatches;
@property (nonatomic, readwrite) <VKRouteLineObserverProtocol> *observer;
...
@property (nonatomic, readwrite) double simplificationEpsilonPoints;
