...
@property (nonatomic, readwrite) float maximumStyleZ;
@property (nonatomic, readwrite, retain) GEOVectorTile *modelTile;
...
@property (nonatomic, readwrite) float textureScale;
