...
@property (nonatomic, readwrite) struct PolylineCoordinate { unsigned int x1; float x2; } routeEnd;
@property (nonatomic, readwrite) struct PolylineCoordinate { unsigned int x1; float x2; } routeStart;
...
@property (nonatomic, readwrite) unsigned char trafficSpeed;
