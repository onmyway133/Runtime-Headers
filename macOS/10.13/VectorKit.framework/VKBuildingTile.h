...
@property (nonatomic, readwrite, retain) VKAnimation *animation;
@property (nonatomic, readwrite, retain) VKAnimation *animationForPitch;
...
@property (nonatomic, readonly) struct Texture2D { int (**x1)(); struct ResourceManager {} *x2; struct RenderResource {} *x3; int (**x4)(); char *x5; int x6; int x7; int x8; int x9; bool x10; unsigned int x11; struct shared_ptr<const ggl::TextureDataAbstract> { struct TextureDataAbstract {} *x_12_1_1; struct __shared_weak_count {} *x_12_1_2; } x12; bool x13; bool x14; unsigned int x15; unsigned int x16; bool x17; struct shared_ptr<ggl::SamplerState> { struct SamplerState {} *x_18_1_1; struct __shared_weak_count {} *x_18_1_2; } x18; }*shadowTexture;
