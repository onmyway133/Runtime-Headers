...
@property (nonatomic, readwrite) unsigned long long currentStepIndex;
@property (nonatomic, readonly) unsigned long long groupedManeuverCount;
@property (nonatomic, readwrite, copy) NSArray *groupedManeuverCounts;
@property (nonatomic, readwrite) unsigned long long navigationCameraHeadingOverride;
...
- (void)dealloc;
- (void)enumerateAdditionalRoutesToFrameUsingBlock:(id)arg1;
