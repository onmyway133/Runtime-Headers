...
@property (nonatomic, readwrite) unsigned char dataType;
@property (nonatomic, readwrite) unsigned int dataValue;
@property (atomic, readonly, copy) NSString *debugDescription;
@property (nonatomic, readonly) unsigned int defaultTransitType;
@property (atomic, readonly, copy) NSString *description;
@property (nonatomic, readwrite, retain) NSArray *fallbackImageKeys;
...
@property (nonatomic, readwrite) struct CGPoint { double x1; double x2; } imageCenter;
@property (nonatomic, readonly) NSString *imageName;
@property (nonatomic, readonly) unsigned int keyType;
@property (nonatomic, readwrite, retain) NSString *relatedText;
...
// VKImageSourceKey (MKTransitArtworkExtras)
