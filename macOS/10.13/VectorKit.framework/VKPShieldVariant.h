...
@property (nonatomic, readwrite) float capWidthLeft;
@property (nonatomic, readwrite) float capWidthRight;
@property (nonatomic, readwrite) float centerOffsetX;
@property (nonatomic, readonly) float*centerPoints;
@property (nonatomic, readonly) unsigned long long centerPointsCount;
@property (nonatomic, readwrite) struct { float x1; unsigned int x2; unsigned int x3; unsigned int x4; } fontColor;
@property (nonatomic, readwrite, retain) NSString *fontName;
@property (nonatomic, readwrite) float fontSize;
@property (nonatomic, readwrite) BOOL hasAtlasIndex;
@property (nonatomic, readwrite) BOOL hasBackgroundColor;
@property (nonatomic, readwrite) BOOL hasBorderColor;
@property (nonatomic, readwrite) BOOL hasCapWidthLeft;
@property (nonatomic, readwrite) BOOL hasCapWidthRight;
@property (nonatomic, readwrite) BOOL hasCenterOffsetX;
@property (nonatomic, readwrite) BOOL hasFontColor;
...
@property (nonatomic, readwrite) BOOL hasMaxDigits;
@property (nonatomic, readwrite) BOOL hasMinDigits;
@property (nonatomic, readwrite) BOOL hasNonDigitFontColor;
@property (nonatomic, readonly) BOOL hasNonDigitFontName;
@property (nonatomic, readwrite) BOOL hasNonDigitFontSize;
@property (nonatomic, readwrite) BOOL hasPaddingLeft;
@property (nonatomic, readwrite) BOOL hasPaddingRight;
@property (nonatomic, readwrite) BOOL hasQuadIndex;
@property (nonatomic, readwrite) BOOL hasTextBaseline;
@property (nonatomic, readwrite) BOOL hasTextMaskColor;
@property (nonatomic, readwrite) BOOL hasTextShadow;
@property (nonatomic, readwrite) BOOL hasTextStroke;
...
@property (nonatomic, readwrite) unsigned int maxDigits;
@property (nonatomic, readwrite) unsigned int minDigits;
@property (nonatomic, readwrite) struct { float x1; unsigned int x2; unsigned int x3; unsigned int x4; } nonDigitFontColor;
@property (nonatomic, readwrite, retain) NSString *nonDigitFontName;
@property (nonatomic, readwrite) float nonDigitFontSize;
@property (nonatomic, readwrite) float paddingLeft;
@property (nonatomic, readwrite) float paddingRight;
@property (nonatomic, readwrite) unsigned int quadIndex;
@property (nonatomic, readwrite) float textBaseline;
@property (nonatomic, readwrite) int textMaskColor;
@property (nonatomic, readwrite) struct { struct { float x_1_1_1; unsigned int x_1_1_2; unsigned int x_1_1_3; unsigned int x_1_1_4; } x1; float x2; float x3; float x4; struct { unsigned int x_5_1_1 : 1; unsigned int x_5_1_2 : 1; } x5; } textShadow;
@property (nonatomic, readwrite) struct { struct { float x_1_1_1; unsigned int x_1_1_2; unsigned int x_1_1_3; unsigned int x_1_1_4; } x1; float x2; } textStroke;
...
// VKPShieldVariant (VKShieldManagerAdditions)
