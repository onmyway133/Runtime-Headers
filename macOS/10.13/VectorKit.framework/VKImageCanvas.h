...
@property (nonatomic, readwrite) <VKImageCanvasDelegate> *delegate;
@property (nonatomic, readwrite) unsigned char emphasis;
@property (nonatomic, readwrite) struct DisplayStyle { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; } mapDisplayStyle;
