...
@property (nonatomic, readwrite) struct shared_ptr<md::LabelMapTile> { struct LabelMapTile {} *x1; struct __shared_weak_count {} *x2; } labelMapTile;
@property (nonatomic, readonly) float maximumStyleZ;
@property (nonatomic, readwrite) BOOL needsRasterization;
@property (nonatomic, readwrite, retain) VKRasterTile *rasterized;
