...
@property (nonatomic, readwrite) struct { double x1; double x2; } location;
...
@property (nonatomic, readwrite, copy) GEOLatLng *position;
...
@property (nonatomic, readwrite) /* Warning: unhandled struct encoding: '{Matrix<double' */ struct  worldPoint; /* unknown property attribute:  1>=[3d]} */
