...
@property (nonatomic, readwrite) /* Warning: unhandled struct encoding: '{Unit<DegreeUnitDescription' */ struct  fieldOfView; /* unknown property attribute:  double>=d} */
...
@property (nonatomic, readwrite) struct MapEngine { int (**x1)(); struct shared_ptr<md::TaskContext> { struct TaskContext {} *x_2_1_1; struct __shared_weak_count {} *x_2_1_2; } x2; /* Warning: unhandled struct encoding: '{_retain_ptr<GEOResourceManifestConfiguration *' */ struct x3; }*mapEngine; /* unknown property attribute:  std::__1::default_delete<md::LogicManager> >=^{LogicManager}}}BBB{atomic<bool>=AB}{atomic<bool>=AB}B} */
@property (nonatomic, readwrite) /* Warning: unhandled struct encoding: '{RigidTransform<double>={Quaternion<double>={Matrix<double' */ struct  offsetTransform; /* unknown property attribute:  1>=[3d]}} */
@property (nonatomic, readwrite) BOOL overrideARFieldOfView;
...
- (void)_setupPounceAnimation:(const struct Coordinate3D<Radians, double> { struct Unit<RadianUnitDescription, double> { double x_1_1_1; } x1; struct Unit<RadianUnitDescription, double> { double x_2_1_1; } x2; struct Unit<MeterUnitDescription, double> { double x_3_1_1; } x3; }*)arg1 duration:(double)arg2 completion:(id)arg3;
...
- (void)trasitionToARModeAtCoordinate:(struct { double x1; double x2; })arg1 withDuration:(double)arg2 completion:(id)arg3;
- (void)trasitionToARModeFromCameraFrame:(const struct CameraFrame<geo::Radians, double> { struct Coordinate3D<Radians, double> { struct Unit<RadianUnitDescription, double> { double x_1_2_1; } x_1_1_1; struct Unit<RadianUnitDescription, double> { double x_2_2_1; } x_1_1_2; struct Unit<MeterUnitDescription, double> { double x_3_2_1; } x_1_1_3; } x1; struct Unit<MeterUnitDescription, double> { double x_2_1_1; } x2; struct Unit<RadianUnitDescription, double> { double x_3_1_1; } x3; struct Unit<RadianUnitDescription, double> { double x_4_1_1; } x4; struct Unit<RadianUnitDescription, double> { double x_5_1_1; } x5; }*)arg1 withDuration:(double)arg2 completion:(id)arg3;
