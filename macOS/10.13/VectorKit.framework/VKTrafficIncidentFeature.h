...
@property (nonatomic, readwrite) BOOL isOnSelectedRoute;
@property (nonatomic, readonly) NSDate *lastUpdatedDate;
@property (nonatomic, readwrite) unsigned int routeOffsetInMeters;
@property (nonatomic, readwrite) long long routeRelevance;
