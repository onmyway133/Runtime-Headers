...
@property (nonatomic, readwrite) long long authoringCameraType;
@property (nonatomic, readwrite, retain) SCNCamera *camera;
...
@property (nonatomic, readwrite) struct SCNVector3 { double x1; double x2; double x3; } eulerAngles;
@property (nonatomic, readwrite, copy) NSArray *filters;
@property (nonatomic, readwrite) long long focusBehavior;
@property (nonatomic, readwrite, retain) SCNGeometry *geometry;
@property (nonatomic, readonly) BOOL hasActions;
@property (atomic, readonly) unsigned long long hash;
@property (getter=isHidden, nonatomic, readwrite) BOOL hidden;
@property (nonatomic, readwrite, retain) SCNLight *light;
@property (nonatomic, readwrite, retain) SCNMorpher *morpher;
@property (nonatomic, readwrite) long long movabilityHint;
@property (nonatomic, readwrite, copy) NSString *name;
@property (nonatomic, readwrite) double opacity;
@property (nonatomic, readwrite) struct SCNVector4 { double x1; double x2; double x3; double x4; } orientation;
@property (nonatomic, readonly) SCNNode *parentNode;
@property (getter=isPaused, nonatomic, readwrite) BOOL paused;
@property (nonatomic, readwrite, retain) SCNPhysicsBody *physicsBody;
@property (nonatomic, readwrite, retain) SCNPhysicsField *physicsField;
...
@property (nonatomic, readwrite) <SCNNodeRendererDelegate> *rendererDelegate;
...
@property (nonatomic, readwrite) void simdEulerAngles;
@property (nonatomic, readwrite) struct { } simdOrientation;
@property (nonatomic, readwrite) struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; } simdPivot;
@property (nonatomic, readwrite) void simdPosition;
@property (nonatomic, readwrite) void simdRotation;
@property (nonatomic, readwrite) void simdScale;
@property (nonatomic, readwrite) struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; } simdTransform;
@property (nonatomic, readonly) void simdWorldFront;
@property (nonatomic, readwrite) struct { } simdWorldOrientation;
@property (nonatomic, readwrite) void simdWorldPosition;
@property (nonatomic, readonly) void simdWorldRight;
@property (nonatomic, readwrite) struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; } simdWorldTransform;
@property (nonatomic, readonly) void simdWorldUp;
@property (nonatomic, readwrite, retain) SCNSkinner *skinner;
...
@property (nonatomic, readonly) struct SCNVector3 { double x1; double x2; double x3; } worldFront;
@property (nonatomic, readwrite) struct SCNVector4 { double x1; double x2; double x3; double x4; } worldOrientation;
@property (nonatomic, readwrite) struct SCNVector3 { double x1; double x2; double x3; } worldPosition;
@property (nonatomic, readonly) struct SCNVector3 { double x1; double x2; double x3; } worldRight;
...
@property (nonatomic, readonly) struct SCNVector3 { double x1; double x2; double x3; } worldUp;
...
- (struct CATransform3D { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; })convertTransform:(struct CATransform3D { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; })arg1 fromNode:(id)arg2;
- (struct CATransform3D { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; })convertTransform:(struct CATransform3D { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; })arg1 toNode:(id)arg2;
- (struct SCNVector3 { double x1; double x2; double x3; })convertVector:(struct SCNVector3 { double x1; double x2; double x3; })arg1 fromNode:(id)arg2;
- (struct SCNVector3 { double x1; double x2; double x3; })convertVector:(struct SCNVector3 { double x1; double x2; double x3; })arg1 toNode:(id)arg2;
- (id)copy;
...
- (BOOL)getBoundingSphereCenter:(struct SCNVector3 { double x1; double x2; double x3; }*)arg1 radius:(double*)arg2;
...
- (void)setWorldOrientation:(struct SCNVector4 { double x1; double x2; double x3; double x4; })arg1;
- (void)setWorldPosition:(struct SCNVector3 { double x1; double x2; double x3; })arg1;
...
- (struct SCNVector4 { double x1; double x2; double x3; double x4; })worldOrientation;
- (struct SCNVector3 { double x1; double x2; double x3; })worldPosition;
...
// SCNNode (SCNAuthoringEnvironment2)
...
+ (struct SCNVector3 { double x1; double x2; double x3; })localRight;
+ (struct SCNVector3 { double x1; double x2; double x3; })localUp;

- (void)localRotateBy:(struct SCNVector4 { double x1; double x2; double x3; double x4; })arg1;
- (void)localTranslateBy:(struct SCNVector3 { double x1; double x2; double x3; })arg1;
- (void)lookAt:(struct SCNVector3 { double x1; double x2; double x3; })arg1;
- (void)lookAt:(struct SCNVector3 { double x1; double x2; double x3; })arg1 up:(struct SCNVector3 { double x1; double x2; double x3; })arg2 localFront:(struct SCNVector3 { double x1; double x2; double x3; })arg3;
- (void)rotateBy:(struct SCNVector4 { double x1; double x2; double x3; double x4; })arg1 aroundTarget:(struct SCNVector3 { double x1; double x2; double x3; })arg2;
- (struct SCNVector3 { double x1; double x2; double x3; })worldFront;
- (struct SCNVector3 { double x1; double x2; double x3; })worldRight;
