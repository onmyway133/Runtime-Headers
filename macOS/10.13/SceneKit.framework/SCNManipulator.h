...
@property (atomic, readonly) SCNAuthoringEnvironment *authoringEnvironment;
@property (nonatomic, readwrite) BOOL readonly;
@property (nonatomic, readwrite, retain) SCNNode *target;
@property (nonatomic, readwrite, retain) NSOrderedSet *targets;
@property (atomic, readonly) struct CATransform3D { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; } transform;
@property (nonatomic, readwrite) long long xAlignment;
@property (nonatomic, readwrite) long long yAlignment;
@property (nonatomic, readwrite) long long zAlignment;
...
- (void)_snapPositionToAlign:(void *)arg1 original:(void *)arg2 unit:(void *)arg3 axisMove:(void *)arg4 rayStart:(void *)arg5 rayDir:(void *)arg6 didSnap:(void *)arg7 snapIndexes:(void *)arg8; // needs 8 arg types, found 5: struct SCNVector3 { double x1; double x2; double x3; }, double, bool, bool*, long long*
