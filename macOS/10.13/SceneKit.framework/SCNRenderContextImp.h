...
@property (nonatomic, readwrite) BOOL collectsCompilationErrors;
@property (nonatomic, readonly) NSDictionary *compilationErrors;
@property (nonatomic, readwrite) double contentScaleFactor;
...
@property (nonatomic, readwrite) BOOL disableLinearRendering;
@property (nonatomic, readwrite) BOOL enablesDeferredShading;
@property (nonatomic, readonly) unsigned int features;
@property (atomic, readonly) unsigned long long hash;
@property (nonatomic, readwrite) BOOL isOpaque;
...
@property (nonatomic, readwrite) long long sampleCount;
@property (nonatomic, readwrite) struct CATransform3D { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; } screenTransform;
@property (nonatomic, readwrite) BOOL showsAuthoringEnvironment;
@property (nonatomic, readwrite) double superSamplingFactor;
@property (atomic, readonly) Class superclass;
@property (nonatomic, readwrite) BOOL wantsWideGamut;
...
- (id)resourceManager;
- (long long)sampleCount;
- (struct CATransform3D { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; })screenTransform;
...
- (void)setScreenTransform:(struct CATransform3D { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; })arg1;
