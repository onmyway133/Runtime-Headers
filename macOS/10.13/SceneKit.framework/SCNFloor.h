...
@property (nonatomic, readwrite) unsigned long long reflectionCategoryBitMask;
@property (nonatomic, readwrite) double reflectionFalloffEnd;
@property (nonatomic, readwrite) double reflectionFalloffStart;
@property (nonatomic, readwrite) double reflectionResolutionScaleFactor;
@property (nonatomic, readwrite) double reflectivity;
