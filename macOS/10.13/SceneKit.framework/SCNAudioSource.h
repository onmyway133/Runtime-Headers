...
@property (getter=isPositional, nonatomic, readwrite) BOOL positional;
@property (nonatomic, readwrite) float rate;
@property (nonatomic, readwrite) float reverbBlend;
@property (nonatomic, readwrite) BOOL shouldStream;
