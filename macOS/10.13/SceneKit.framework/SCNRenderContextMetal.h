...
@property (nonatomic, readwrite, retain) <MTLCommandBuffer> *clientCommandBuffer;
@property (nonatomic, readwrite, retain) <MTLRenderCommandEncoder> *clientRenderCommandEncoder;
@property (nonatomic, readwrite, retain) MTLRenderPassDescriptor *clientRenderPassDescriptor;
@property (nonatomic, readwrite, retain) <MTLCommandQueue> *commandQueue;
