...
@interface SCNMaterialProperty : NSObject <NSSecureCoding, SCNAnimatable> {
    ...
    struct CATransform3D { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; } * _contentTransform;
...
@property (nonatomic, readwrite) long long magnificationFilter;
@property (nonatomic, readwrite) long long mappingChannel;
@property (nonatomic, readwrite) double maxAnisotropy;
@property (nonatomic, readwrite) long long minificationFilter;
@property (nonatomic, readwrite) long long mipFilter;
@property (atomic, readonly) Class superclass;
@property (nonatomic, readwrite) long long textureComponents;
@property (nonatomic, readwrite) long long wrapS;
@property (nonatomic, readwrite) long long wrapT;
...
// SCNMaterialProperty (SCNUIDynamicUI)
