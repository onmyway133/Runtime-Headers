...
@property (nonatomic, readwrite, retain) SCNMetalLibraryManager *libraryManager;
...
// SCNMetalResourceManager (PBR)

- (void)_bakeSphericalHamonicsBasedIrradianceTexture:(id)arg1 forEnvironmentTexture:(id)arg2 applySH:(id)arg3;
...
- (id)irradianceTextureForEnvironmentTexture:(id)arg1 queue:(id)arg2 group:(id)arg3 applySH:(id)arg4;
...
// SCNMetalResourceManager (Textures)
