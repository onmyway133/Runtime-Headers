...
@property (nonatomic, readwrite) double capRadius;
@property (nonatomic, readwrite) long long capSegmentCount;
@property (nonatomic, readwrite) double height;
@property (nonatomic, readwrite) long long heightSegmentCount;
@property (nonatomic, readwrite) long long radialSegmentCount;
