...
@property (nonatomic, readwrite) long long heightSegmentCount;
@property (nonatomic, readwrite) double length;
@property (nonatomic, readwrite) long long lengthSegmentCount;
@property (nonatomic, readwrite) double width;
@property (nonatomic, readwrite) long long widthSegmentCount;
