...
@property (nonatomic, readwrite) double maximumPointScreenSpaceRadius;
@property (nonatomic, readwrite) double minimumPointScreenSpaceRadius;
@property (nonatomic, readwrite) double pointSize;
@property (nonatomic, readonly) long long primitiveCount;
@property (nonatomic, readwrite) struct _NSRange { unsigned long long x1; unsigned long long x2; } primitiveRange;
