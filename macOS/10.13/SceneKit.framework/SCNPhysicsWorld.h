...
@property (atomic, readwrite) <SCNPhysicsContactDelegate> *contactDelegate;
@property (nonatomic, readwrite) struct SCNVector3 { double x1; double x2; double x3; } gravity;
