...
- (void)_fillNodeA:(id)arg1 nodeB:(id)arg2 contactPoint:(struct SCNVector3 { double x1; double x2; double x3; })arg3 collisionImpulse:(struct SCNVector3 { double x1; double x2; double x3; })arg4 distance:(double)arg5 hitFraction:(double)arg6;
- (void)_prepareUpdate;
