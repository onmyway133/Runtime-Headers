...
@property (nonatomic, readwrite) double pipeRadius;
@property (nonatomic, readwrite) long long pipeSegmentCount;
@property (nonatomic, readwrite) double ringRadius;
@property (nonatomic, readwrite) long long ringSegmentCount;
