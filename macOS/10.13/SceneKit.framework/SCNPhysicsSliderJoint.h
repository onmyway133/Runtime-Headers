...
@property (nonatomic, readwrite) struct SCNVector3 { double x1; double x2; double x3; } anchorA;
@property (nonatomic, readwrite) struct SCNVector3 { double x1; double x2; double x3; } anchorB;
@property (nonatomic, readwrite) struct SCNVector3 { double x1; double x2; double x3; } axisA;
@property (nonatomic, readwrite) struct SCNVector3 { double x1; double x2; double x3; } axisB;
@property (nonatomic, readonly) SCNPhysicsBody *bodyA;
@property (nonatomic, readonly) SCNPhysicsBody *bodyB;
@property (nonatomic, readwrite) double maximumAngularLimit;
@property (nonatomic, readwrite) double maximumLinearLimit;
@property (nonatomic, readwrite) double minimumAngularLimit;
@property (nonatomic, readwrite) double minimumLinearLimit;
@property (nonatomic, readwrite) double motorMaximumForce;
@property (nonatomic, readwrite) double motorMaximumTorque;
@property (nonatomic, readwrite) double motorTargetAngularVelocity;
@property (nonatomic, readwrite) double motorTargetLinearVelocity;
