...
@property (nonatomic, readwrite, copy) NSString *alignmentMode;
@property (nonatomic, readwrite, copy) NSBezierPath *chamferProfile;
@property (nonatomic, readwrite) double chamferRadius;
@property (nonatomic, readwrite) long long chamferSegmentCount;
@property (nonatomic, readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } containerFrame;
@property (nonatomic, readwrite) double extrusionDepth;
@property (nonatomic, readwrite) double flatness;
@property (nonatomic, readwrite, retain) NSFont *font;
@property (nonatomic, readwrite, copy) id string;
@property (nonatomic, readonly) struct CGSize { double x1; double x2; } textSize;
@property (nonatomic, readwrite, copy) NSString *truncationMode;
@property (getter=isWrapped, nonatomic, readwrite) BOOL wrapped;
