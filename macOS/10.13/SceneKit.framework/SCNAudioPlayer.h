...
@property (atomic, readonly) AVAudioPlayerNode *audioPlayer;
@property (nonatomic, readonly) SCNAudioSource *audioSource;
@property (atomic, readwrite) BOOL completed;
@property (atomic, readonly) BOOL customAudioNode;
@property (nonatomic, readwrite, copy) id didFinishPlayback;
@property (atomic, readonly) struct __C3DScene { }*scene;
@property (nonatomic, readwrite, copy) id willStartPlayback;
