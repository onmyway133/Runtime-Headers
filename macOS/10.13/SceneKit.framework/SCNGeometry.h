...
@property (nonatomic, readwrite, retain) SCNGeometryElement *edgeCreasesElement;
@property (nonatomic, readwrite, retain) SCNGeometrySource *edgeCreasesSource;
@property (nonatomic, readwrite, retain) SCNMaterial *firstMaterial;
...
@property (nonatomic, readwrite, copy) NSArray *levelsOfDetail;
...
@property (nonatomic, readwrite) unsigned long long subdivisionLevel;
@property (atomic, readonly) Class superclass;
@property (nonatomic, readwrite, retain) SCNGeometryTessellator *tessellator;
@property (nonatomic, readwrite) BOOL wantsAdaptiveSubdivision;
