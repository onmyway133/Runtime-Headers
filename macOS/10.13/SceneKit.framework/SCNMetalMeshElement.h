...
@property (nonatomic, readwrite, retain) SCNMTLBuffer *indexBuffer;
@property (nonatomic, readwrite) long long indexCount;
@property (nonatomic, readwrite) unsigned long long indexType;
@property (nonatomic, readwrite) unsigned long long instanceCount;
@property (nonatomic, readonly) long long primitiveCount;
@property (nonatomic, readwrite) unsigned long long primitiveType;
@property (nonatomic, readwrite) long long sharedIndexBufferOffset;
