...
@property (nonatomic, readwrite, retain) NSURL *IESProfileURL;
@property (atomic, readonly) NSArray *animationKeys;
@property (nonatomic, readwrite) double attenuationEndDistance;
@property (nonatomic, readwrite) double attenuationFalloffExponent;
@property (nonatomic, readwrite) double attenuationStartDistance;
@property (nonatomic, readwrite) BOOL automaticallyAdjustsShadowProjection;
...
@property (nonatomic, readwrite) BOOL forcesBackFaceCasters;
@property (nonatomic, readonly) SCNMaterialProperty *gobo;
@property (atomic, readonly) unsigned long long hash;
@property (nonatomic, readwrite) double intensity;
@property (nonatomic, readwrite) double maximumShadowDistance;
@property (nonatomic, readwrite, copy) NSString *name;
@property (nonatomic, readwrite) double orthographicScale;
@property (nonatomic, readwrite) BOOL sampleDistributedShadowMaps;
@property (nonatomic, readwrite) double shadowBias;
@property (nonatomic, readwrite) unsigned long long shadowCascadeCount;
@property (nonatomic, readwrite) double shadowCascadeSplittingFactor;
@property (nonatomic, readwrite, retain) id shadowColor;
@property (nonatomic, readwrite) struct CGSize { double x1; double x2; } shadowMapSize;
@property (nonatomic, readwrite) long long shadowMode;
@property (nonatomic, readwrite) double shadowRadius;
@property (nonatomic, readwrite) unsigned long long shadowSampleCount;
@property (nonatomic, readonly, copy) NSData *sphericalHarmonicsCoefficients;
@property (nonatomic, readwrite) double spotInnerAngle;
@property (nonatomic, readwrite) double spotOuterAngle;
