...
- (void)main;
- (void)renderAndAppendWithPresentationTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 usingAdaptor:(id)arg2 metalTextureCache:(struct __CVMetalTextureCache { }*)arg3 cvQueue:(id)arg4 completionBlock:(id)arg5;
