...
@property (nonatomic, readwrite) unsigned long long platform;
@property (nonatomic, readwrite, copy) NSDictionary *preferencesAfterMigration;
@property (nonatomic, readwrite, copy) NSDictionary *preferencesBeforeMigration;
@property (nonatomic, readwrite, copy) NSString *previousVersion;
