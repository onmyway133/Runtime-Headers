...
@property (nonatomic, readwrite) BOOL canNavigate;
...
@property (nonatomic, readwrite, retain) GEOMapItemStorage *destination;
@property (nonatomic, readwrite, retain) NSString *destinationName;
@property (nonatomic, readwrite) unsigned int distance;
@property (nonatomic, readwrite) BOOL hasCanNavigate;
...
@property (nonatomic, readwrite) BOOL hasHistoricalDuration;
@property (nonatomic, readonly) BOOL hasName;
@property (nonatomic, readonly) BOOL hasOrigin;
@property (nonatomic, readwrite) BOOL hasOriginalDuration;
...
@property (nonatomic, readwrite) unsigned int historicalDuration;
@property (nonatomic, readwrite, retain) NSString *name;
@property (nonatomic, readwrite, retain) GEOMapItemStorage *origin;
@property (nonatomic, readwrite) unsigned int originalDuration;
@property (nonatomic, readwrite, retain) NSData *originalRouteID;
@property (nonatomic, readwrite, retain) GEOTransitSuggestedRoute *originalSuggestedRoute;
...
// GEOCompanionRouteDetails (CompanionExtras)
