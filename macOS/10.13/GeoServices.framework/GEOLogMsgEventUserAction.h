...
@property (nonatomic, readwrite) BOOL hasUserActionEventTarget;
@property (nonatomic, readonly) BOOL hasUserActionEventValue;
@property (nonatomic, readwrite, retain) NSString *userActionEventKey;
@property (nonatomic, readwrite) int userActionEventTarget;
@property (nonatomic, readwrite, retain) NSString *userActionEventValue;
