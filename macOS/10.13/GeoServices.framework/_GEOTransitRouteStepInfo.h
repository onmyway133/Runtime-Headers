...
@property (nonatomic, readwrite) struct _NSRange { unsigned long long x1; unsigned long long x2; } maneuverPointRange;
@property (nonatomic, readwrite) struct _NSRange { unsigned long long x1; unsigned long long x2; } pointRange;
@property (nonatomic, readwrite) long long routeLegType;
@property (nonatomic, readwrite, retain) GEOTransitStep *transitStep;
@property (nonatomic, readwrite, retain) GEOStep *walkingStep;
