...
@property (nonatomic, readwrite) int cellWifi;
@property (nonatomic, readwrite, retain) NSString *countryCode;
@property (nonatomic, readwrite) int geoService;
@property (nonatomic, readwrite) BOOL hasCellWifi;
@property (nonatomic, readonly) BOOL hasCountryCode;
@property (nonatomic, readwrite) BOOL hasGeoService;
...
@property (nonatomic, readwrite) BOOL hasSessionIDIsPersistent;
...
@property (nonatomic, readwrite) BOOL sessionIDIsPersistent;
