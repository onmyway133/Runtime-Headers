...
@property (nonatomic, readwrite) BOOL completedAsCancelled;
@property (nonatomic, readwrite, retain) <GEODataSessionTask> *dataTask;
@property (atomic, readonly, copy) NSString *debugDescription;
@property (nonatomic, readwrite) <GEOProtobufSessionTaskDelegate> *delegate;
...
@property (nonatomic, readwrite) GEOProtobufSession *session;
...
- (void)updateDataRequest:(id)arg1 withNewProtobufRequest:(id)arg2 completionHandler:(id)arg3;
