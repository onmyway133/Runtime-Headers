...
@property (nonatomic, readwrite, retain) NSMutableArray *alightNotificationFeedbacks;
@property (nonatomic, readwrite, retain) NSData *directionResponseID;
@property (nonatomic, readwrite, retain) NSMutableArray *guidanceFeedbacks;
@property (nonatomic, readonly) BOOL hasDirectionResponseID;
@property (nonatomic, readwrite, retain) NSMutableArray *stepFeedbacks;
@property (nonatomic, readwrite, retain) NSMutableArray *trafficRerouteFeedbacks;
