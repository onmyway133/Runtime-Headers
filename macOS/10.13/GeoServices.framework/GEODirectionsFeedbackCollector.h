...
@property (nonatomic, readwrite, retain) GEODirectionsFeedback *currentDirectionsFeedback;
@property (nonatomic, readwrite, retain) GEODirectionsFeedbackLogMessage *currentFeedbackLogMessage;
@property (nonatomic, readwrite, retain) NSMutableSet *routeIDs;
