...
@property (nonatomic, readwrite, retain) NSData *checksum;
@property (nonatomic, readwrite) int connectionType;
@property (nonatomic, readwrite, retain) NSString *filename;
@property (nonatomic, readwrite, retain) NSMutableArray *filters;
...
@property (nonatomic, readwrite) BOOL hasPreferWiFiAllowedStaleThreshold;
@property (nonatomic, readwrite) BOOL hasResourceType;
@property (nonatomic, readwrite) unsigned int preferWiFiAllowedStaleThreshold;
...
@property (nonatomic, readwrite) int resourceType;
