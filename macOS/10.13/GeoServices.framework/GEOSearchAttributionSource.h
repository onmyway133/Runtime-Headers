...
@property (nonatomic, readwrite, retain) NSMutableArray *attributionApps;
...
@property (nonatomic, readwrite) BOOL enforceAppStore;
@property (nonatomic, readwrite) BOOL hasEnforceAppStore;
@property (nonatomic, readonly) BOOL hasWebBaseActionURL;
@property (nonatomic, readwrite, retain) NSMutableArray *localizedAttributions;
@property (nonatomic, readwrite, retain) NSString *sourceIdentifier;
@property (nonatomic, readwrite) unsigned int sourceVersion;
@property (nonatomic, readwrite, retain) NSMutableArray *supportedComponentActions;
@property (nonatomic, readwrite, retain) NSString *webBaseActionURL;
...
// GEOSearchAttributionSource (GEOLocalization)

- (id)bestLocalizedAttribution;

// GEOSearchAttributionSource (GEOMapItemAttributionExtras)
