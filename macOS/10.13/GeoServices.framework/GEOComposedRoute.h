...
@property (nonatomic, readwrite) unsigned long long currentDisplayStep;
...
@property (nonatomic, readwrite) unsigned int firstVisiblePoint;
...
@property (nonatomic, readwrite) BOOL maneuverDisplayEnabled;
@property (nonatomic, readwrite, retain) NSArray *maneuverDisplaySteps;
...
@property (nonatomic, readwrite) unsigned long long selectedLegIndex;
@property (nonatomic, readwrite) BOOL shouldShowSchedule;
...
@property (nonatomic, readwrite, retain) NSArray *trafficIncidentOffsets;
@property (nonatomic, readwrite, retain) NSArray *trafficIncidents;
...
@property (nonatomic, readwrite, retain) NSMapTable *turnAnglesLookup;
