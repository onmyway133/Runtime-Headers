...
@property (nonatomic, readwrite, retain) NSMutableArray *accessPoints;
@property (nonatomic, readwrite, retain) NSMutableArray *artworks;
@property (nonatomic, readwrite, retain) NSMutableArray *halls;
@property (nonatomic, readwrite, retain) NSMutableArray *lines;
@property (nonatomic, readwrite, retain) NSMutableArray *stations;
@property (nonatomic, readwrite, retain) NSMutableArray *steps;
@property (nonatomic, readwrite, retain) NSMutableArray *stops;
@property (nonatomic, readwrite, retain) NSMutableArray *systems;
@property (nonatomic, readwrite, retain) NSMutableArray *transitIncidentMessages;
@property (nonatomic, readwrite, retain) NSMutableArray *transitIncidents;
@property (nonatomic, readwrite, retain) NSMutableArray *walkings;
@property (nonatomic, readwrite, retain) NSMutableArray *zilchPoints;
...
// GEOTransitDecoderData (GEOTransitExtras)
