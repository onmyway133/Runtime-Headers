...
@property (nonatomic, readwrite) unsigned int firstLaneIndex;
@property (nonatomic, readwrite) unsigned int firstRoadIndex;
@property (nonatomic, readwrite) unsigned int secondLaneIndex;
@property (nonatomic, readwrite) unsigned int secondRoadIndex;
