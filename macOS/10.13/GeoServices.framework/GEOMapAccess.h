...
@property (nonatomic, readwrite) <GEOMapAccessRestrictions> *restrictions;
@property (nonatomic, readonly) unsigned long long roadsZoomLevel;
@property (nonatomic, readwrite, copy) id tileErrorHandler;
@property (nonatomic, readonly) unsigned long long transitZoomLevel;
@property (nonatomic, readwrite) BOOL useMapMatchingTilesetForRoads;
@property (nonatomic, readwrite) unsigned int zoomLevel;
