...
@property (atomic, readonly) NSArray *edges;
@property (atomic, readonly) BOOL hasCompletedMapMatching;
@property (atomic, readonly) BOOL isMapMatched;
@property (atomic, readonly) BOOL isMapMatching;
@property (atomic, readonly) const struct RouteMapMatchingSection { int (**x1)(); }*mapMatchingSection;
@property (atomic, readonly) unsigned int routeEndIndex;
@property (atomic, readonly) unsigned int routeStartIndex;
@property (atomic, readonly) GEOComposedRouteSection *section;
