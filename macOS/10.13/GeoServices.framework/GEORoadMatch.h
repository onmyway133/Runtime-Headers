...
@property (nonatomic, readwrite) struct { double x1; double x2; } coordinateOnRoad;
@property (nonatomic, readwrite) double courseOnRoad;
@property (nonatomic, readwrite) double distanceFromJunction;
@property (nonatomic, readwrite) double distanceFromRoad;
@property (nonatomic, readwrite) double junctionRadius;
...
@property (nonatomic, readwrite) double roadWidth;
