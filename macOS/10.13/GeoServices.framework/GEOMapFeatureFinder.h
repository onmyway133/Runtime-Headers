...
@property (nonatomic, readwrite) BOOL ignoreUnnamedFeatures;
@property (nonatomic, readonly) GEOMapAccess *map;
@property (nonatomic, readwrite, copy) id pointHandler;
@property (nonatomic, readwrite, copy) id polygonHandler;
@property (nonatomic, readwrite, copy) id roadHandler;
