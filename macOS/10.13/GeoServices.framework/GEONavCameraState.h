...
@property (nonatomic, readwrite) int distanceToManeuver;
@property (nonatomic, readwrite) BOOL hasDistanceToManeuver;
@property (nonatomic, readwrite) BOOL hasIsGroupedManeuver;
@property (nonatomic, readwrite) BOOL hasSpeedBucket;
@property (nonatomic, readwrite) BOOL hasUpcomingManeuverType;
@property (nonatomic, readwrite) BOOL isGroupedManeuver;
@property (nonatomic, readwrite) int speedBucket;
@property (nonatomic, readwrite) int upcomingManeuverType;
