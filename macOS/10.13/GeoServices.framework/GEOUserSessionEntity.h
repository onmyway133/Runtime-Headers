...
@property (atomic, readwrite) double sessionCreationTime;
@property (nonatomic, readonly) NSString *sessionEntityString;
@property (atomic, readwrite) struct GEOSessionID { unsigned long long x1; unsigned long long x2; } sessionID;
...
@property (atomic, readonly) double sessionRelativeTimestamp;
