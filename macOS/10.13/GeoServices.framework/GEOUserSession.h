...
@property (atomic, readonly) GEOUserSessionEntity *cohortSessionEntity;
@property (atomic, readonly) GEOUserSessionEntity *longSessionEntity;
@property (nonatomic, readwrite, retain) GEOUserSessionEntity *mapsUserSessionEntity;
@property (atomic, readonly) GEOUserSessionEntity *navSessionEntity;
@property (atomic, readwrite) BOOL shareSessionWithMaps;
@property (atomic, readonly) struct GEOSessionID { unsigned long long x1; unsigned long long x2; } usageCollectionSessionID;
@property (atomic, readonly) GEOUserSessionSnapshot *userSessionSnapshot;
@property (atomic, readwrite) BOOL zeroSessionIDMode;
