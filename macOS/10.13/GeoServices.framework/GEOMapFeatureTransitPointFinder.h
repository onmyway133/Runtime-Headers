...
- (id)findGeometryForTransitPoint:(id)arg1 completionHandler:(id)arg2;
- (id)findParentOfTransitPoint:(id)arg1 handler:(id)arg2 completionHandler:(id)arg3;
- (id)findTransitAccessPointsForStation:(id)arg1 handler:(id)arg2 completionHandler:(id)arg3;
- (id)findTransitPointWithID:(unsigned long long)arg1 near:(struct { double x1; double x2; })arg2 handler:(id)arg3 completionHandler:(id)arg4;
- (id)findTransitPointsOfType:(unsigned long long)arg1 near:(struct { double x1; double x2; })arg2 radius:(double)arg3 handler:(id)arg4 completionHandler:(id)arg5;
- (id)findTransitPointsWithParent:(id)arg1 handler:(id)arg2 completionHandler:(id)arg3;
