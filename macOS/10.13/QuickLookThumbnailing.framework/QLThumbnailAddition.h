...
@property (atomic, readonly) unsigned long long additionSize;
@property (atomic, readwrite, retain) NSURL *additionURL;
@property (atomic, readonly) GSAddition *genStoreAddition;
@property (atomic, readwrite, retain) NSDictionary *metadata;
@property (atomic, readwrite, retain) NSDictionary *thumbnailDataDictionary;
@property (atomic, readonly) QLThumbnailVersion *thumbnailVersion;
...
- (id)thumbnailVersion;
- (struct CGImage { }*)thumbnailWithMaximumDimension:(double)arg1 contentRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg2 flavor:(int*)arg3 lowQuality:(BOOL*)arg4 properties:(id*)arg5;
