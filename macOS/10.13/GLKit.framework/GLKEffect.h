...
@property (nonatomic, readwrite) int aColorLoc;
@property (nonatomic, readwrite) union _GLKVector4 { struct { float x_1_1_1; float x_1_1_2; float x_1_1_3; float x_1_1_4; } x1; struct { float x_2_1_1; float x_2_1_2; float x_2_1_3; float x_2_1_4; } x2; struct { float x_3_1_1; float x_3_1_2; float x_3_1_3; float x_3_1_4; } x3; float x4[4]; } baseLightingColor;
@property (nonatomic, readwrite) int baseLightingColorLoc;
@property (nonatomic, readwrite) unsigned char colorMaterialEnabled;
@property (nonatomic, readwrite) unsigned long long dirtyUniforms;
@property (nonatomic, readwrite) id*effectShaderArray;
@property (nonatomic, readwrite) struct GLKBigInt_s { unsigned long long x1; unsigned long long x2; }*fshMask;
@property (nonatomic, readwrite) unsigned int fshName;
@property (nonatomic, readonly) GLKShaderBlockNode *fshRootNode;
@property (nonatomic, readwrite) char **fshStrings;
@property (nonatomic, readwrite, copy) NSString *label;
@property (nonatomic, readwrite) union _GLKVector4 { struct { float x_1_1_1; float x_1_1_2; float x_1_1_3; float x_1_1_4; } x1; struct { float x_2_1_1; float x_2_1_2; float x_2_1_3; float x_2_1_4; } x2; struct { float x_3_1_1; float x_3_1_2; float x_3_1_3; float x_3_1_4; } x3; float x4[4]; } lightModelAmbientColor;
@property (nonatomic, readwrite) int lightModelAmbientColorLoc;
@property (nonatomic, readwrite) unsigned char lightModelTwoSided;
@property (nonatomic, readwrite, retain) NSMutableArray *lightProperties;
...
@property (nonatomic, readwrite) unsigned int numFshStrings;
@property (nonatomic, readwrite) unsigned int numLights;
@property (nonatomic, readwrite) unsigned int numTextures;
@property (nonatomic, readwrite) unsigned int numVshStrings;
@property (nonatomic, readwrite) unsigned char perPixelLightingEnabled;
@property (nonatomic, readwrite) unsigned char perVertexLightingEnabled;
@property (nonatomic, readwrite) struct GLKBigInt_s { unsigned long long x1; unsigned long long x2; } prevFshMask;
@property (nonatomic, readwrite) struct GLKBigInt_s { unsigned long long x1; unsigned long long x2; } prevVshMask;
...
@property (nonatomic, readwrite, copy) NSArray *textureOrder;
@property (nonatomic, readwrite) bool textureOrderStale;
@property (nonatomic, readwrite) unsigned char texturingEnabled;
@property (nonatomic, readwrite) struct GLKBigInt_s { unsigned long long x1; unsigned long long x2; }*vshMask;
@property (nonatomic, readwrite) unsigned int vshName;
@property (nonatomic, readonly) GLKShaderBlockNode *vshRootNode;
@property (nonatomic, readwrite) char **vshStrings;
