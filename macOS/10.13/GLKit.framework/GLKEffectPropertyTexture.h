...
@property (nonatomic, readwrite) int envMode;
@property (nonatomic, readonly) NSString *filePath;
@property (nonatomic, readwrite) unsigned char matrixEnabled;
@property (nonatomic, readwrite) unsigned int name;
...
@property (nonatomic, readwrite) int textureIndex;
@property (nonatomic, readwrite) int unit2dLoc;
@property (nonatomic, readwrite) char *unit2dNameString;
@property (nonatomic, readwrite) int unitCubeLoc;
@property (nonatomic, readwrite) char *unitCubeNameString;
