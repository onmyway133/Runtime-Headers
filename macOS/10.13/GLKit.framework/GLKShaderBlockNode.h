...
@property (nonatomic, readwrite, retain) NSMutableString *blockText;
@property (nonatomic, readwrite) GLKShaderBlockNode *children;
@property (atomic, readonly, copy) NSString *debugDescription;
@property (atomic, readonly, copy) NSString *description;
@property (atomic, readonly) unsigned long long hash;
@property (nonatomic, readwrite) unsigned int index;
@property (nonatomic, readwrite) BOOL indexedMask;
@property (nonatomic, readwrite, copy) NSString *label;
@property (nonatomic, readwrite, copy) NSString *loopVar;
@property (nonatomic, readwrite) struct GLKBigInt_s { unsigned long long x1; unsigned long long x2; } mask;
@property (nonatomic, readwrite) GLKShaderBlockNode *next;
@property (nonatomic, readwrite) GLKShaderBlockNode *parent;
@property (nonatomic, readwrite) int propertyClass;
@property (atomic, readonly) Class superclass;
@property (nonatomic, readwrite) int type;
@property (nonatomic, readwrite) int unrollCt;
