...
@property (atomic, readonly, retain) WKDOMNode *endContainer;
@property (atomic, readonly) long long endOffset;
@property (atomic, readonly) BOOL isCollapsed;
@property (atomic, readonly, retain) WKDOMNode *startContainer;
@property (atomic, readonly) long long startOffset;
