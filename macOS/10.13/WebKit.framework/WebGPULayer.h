...
@property (nonatomic, readwrite) struct GPUDevice { unsigned int x1; struct RetainPtr<WebGPULayer> { void *x_2_1_1; } x2; struct RetainPtr<id> { void *x_3_1_1; } x3; }*context;
