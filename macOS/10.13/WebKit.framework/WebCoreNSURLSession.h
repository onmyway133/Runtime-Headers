...
@property (atomic, readwrite, retain) <NSURLSessionTaskDelegate> *delegate;
@property (atomic, readonly, retain) NSOperationQueue *delegateQueue;
@property (atomic, readonly) BOOL didPassCORSAccessChecks;
@property (atomic, readonly) struct PlatformMediaResourceLoader { int (**x1)(); struct atomic<unsigned int> { unsigned int x_2_1_1; } x2; }*loader;
