...
@interface NSMenuItem : NSObject <DebugHierarchyObject, NSAccessibility, NSAccessibilityElement, NSCoding, NSCopying, NSImmediateActionAnimationController, NSMenuItem, NSUserInterfaceItemIdentification, NSValidatedUserInterfaceItem> {
    SEL  _action;
    id  _extraData;
...
@property (atomic, readwrite) BOOL allowsKeyEquivalentWhenHidden;
...
- (void)_setImageSize:(struct CGSize { double x1; double x2; })arg1;
...
- (SEL)action;
- (BOOL)allowsKeyEquivalentWhenHidden;
- (id)attributedTitle;
...
// NSMenuItem (DebugHierarchyAdditions)
