...
- (id)candidatesForSelectedRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 inString:(id)arg2 types:(unsigned long long)arg3 options:(id)arg4 offset:(unsigned long long)arg5 orthography:(id)arg6 inSpellDocumentWithTag:(long long)arg7;
...
- (long long)requestCandidatesForSelectedRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 inString:(id)arg2 types:(unsigned long long)arg3 options:(id)arg4 inSpellDocumentWithTag:(long long)arg5 completionHandler:(id)arg6;
