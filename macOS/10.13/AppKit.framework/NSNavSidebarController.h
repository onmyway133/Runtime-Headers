...
@interface NSNavSidebarController : NSObject <NSOutlineViewDataSource, NSOutlineViewDelegate> {
    NSNavVirtualNode * _appSmartFoldersNode;
    unsigned int  _changingRootNode;
...
- (void)outlineView:(id)arg1 draggedImage:(id)arg2 movedTo:(struct CGPoint { double x1; double x2; })arg3;
- (void)outlineView:(id)arg1 draggingEndedAt:(struct CGPoint { double x1; double x2; })arg2 operation:(unsigned long long)arg3;
