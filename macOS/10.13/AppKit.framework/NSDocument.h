...
@property (atomic, readonly) BOOL allowsDocumentSharing;
...
- (void)_presentAlertWithPrimaryMessage:(id)arg1 secondaryMessage:(id)arg2 firstButtonLabel:(id)arg3 isDefault:(BOOL)arg4 alternateButtonLabel:(id)arg5 otherButtonLabel:(id)arg6 ignoreAccidentalEvents:(BOOL)arg7 guardAlternateButton:(BOOL)arg8 thenContinue:(id)arg9;
- (void)_presentAlertWithPrimaryMessage:(id)arg1 secondaryMessage:(id)arg2 firstButtonLabel:(id)arg3 isDefault:(BOOL)arg4 alternateButtonLabel:(id)arg5 otherButtonLabel:(id)arg6 ignoreAccidentalEvents:(BOOL)arg7 showSuppressionButton:(BOOL)arg8 guardAlternateButton:(BOOL)arg9 thenContinue:(id)arg10;
...
- (void)_runModalOpenPanelForMoving:(id)arg1 thenContinue:(id)arg2;
...
- (void)shareDocumentWithSharingService:(id)arg1 completionHandler:(id)arg2;
- (void)shareItemAtURL:(id)arg1 withService:(id)arg2 completionHandler:(id)arg3;
- (id)shareItemData;
- (id)shareItemImage;
- (id)shareItemString;
- (id)shareItemType;
