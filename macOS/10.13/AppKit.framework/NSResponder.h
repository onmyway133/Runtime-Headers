...
@interface NSResponder : NSObject <NSCoding, NSFunctionBarProvider, NSTouchBarProvider, NSTouchBarProviderContainer, NSUIActivityProvider> {
    id  _nextResponder;
}

@property (atomic, readonly) NSString *_responderDebugDescription;
@property (atomic, readonly) BOOL acceptsFirstResponder;
@property (atomic, readonly, copy) NSString *debugDescription;
@property (atomic, readonly, copy) NSString *description;
@property (atomic, readwrite, retain) NSTouchBar *functionBar;
...
@property (atomic, readwrite, retain) NSTouchBar *touchBar;
...
// NSResponder (NSFunctionBarProvider)

- (id)functionBar;
- (id)makeFunctionBar;
- (void)setFunctionBar:(id)arg1;
...
// NSResponder (NSTouchBarFinder)

- (id)NS_touchBarProviders;
- (id)NS_touchBarProvidersKeyPaths;

// NSResponder (NSTouchBarProvider)
