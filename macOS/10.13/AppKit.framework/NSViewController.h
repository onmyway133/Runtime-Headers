...
@interface NSViewController : NSResponder <DebugHierarchyObject, NSCoding, NSExtensionRequestHandling, NSNibFinishedLoadingDependent, NSSeguePerforming, NSServiceViewControllerActionResponder, NSUserInterfaceItemIdentification> {
    id  __privateData;
    id  _autounbinder;
...
@property (atomic, readonly, copy) NSArray *_nibLoadingDependencies;
...
// NSViewController (ResponderDebug)
...
// NSViewController (DebugHierarchyAdditions)
...
// NSViewController (NSServiceViewController)
