...
@interface NSWindow : NSResponder <DebugHierarchyObject, NSAccessibility, NSAccessibilityElement, NSAnimatablePropertyContainer, NSAppearanceCustomization, NSServiceViewControllerActionResponder, NSTouchBarProviderContainer, NSUserInterfaceItemIdentification, NSUserInterfaceValidations> {
...
@property (atomic, readwrite, retain) NSResponder *_beforeTabPickerResponder;
@property (atomic, readonly) NSCGSWindow *_cgsWindow;
@property (atomic, readonly) CAContext *_contextForLayerHosting;
@property (getter=_isFunctionRowWindow, atomic, readonly) BOOL _functionRowWindow;
...
@property (atomic, readonly, retain) NSTabBarItem *_tabBarItem;
...
@property (atomic, readonly, copy) NSArray *drawers;
...
@property (atomic, readonly) unsigned long long resizeFlags;
...
@property (atomic, readonly) NSWindowTab *tab;
@property (atomic, readonly) NSWindowTabGroup *tabGroup;
@property (getter=isTabOverviewVisible, atomic, readonly) BOOL tabOverviewVisible;
...
@property (atomic, readwrite) BOOL viewBridgeBecomingChild;
...
+ (void)_minimizeAll;
+ (struct _NSModalSession { id x1; struct _NSModalSession {} *x2; int x3; BOOL x4; long long x5; unsigned long long x6; BOOL x7; BOOL x8; BOOL x9; short x10; long long x11; id x12; SEL x13; void *x14; long long x15; id x16; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x17; id x18; }*)_modalSessionForShownService:(id)arg1;
...
- (void)_cgsMoveWindow:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 moveGroup:(BOOL)arg2;
- (void)_cgsPlaceWindow:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (id)_cgsWindow;
- (void)_cgsWindowRelativeMoveChildrenWithGroupWithDelta:(struct CGPoint { double x1; double x2; })arg1;
...
- (void)_endWindowBlockingModalSession:(struct _NSModalSession { id x1; struct _NSModalSession {} *x2; int x3; BOOL x4; long long x5; unsigned long long x6; BOOL x7; BOOL x8; BOOL x9; short x10; long long x11; id x12; SEL x13; void *x14; long long x15; id x16; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x17; id x18; }*)arg1 returnCode:(long long)arg2;
...
// NSWindow (NSAllowsLinearMaskOverlay)
...
- (void)_fromConstraintsCalculateWindowMinSize:(struct CGSize { double x1; double x2; }*)arg1 maxSize:(struct CGSize { double x1; double x2; }*)arg2 allowDynamicLayout:(BOOL)arg3 changingOnlySlightly:(BOOL)arg4;
...
- (id)_beginDraggingSessionWithItems:(id)arg1 clipRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 event:(id)arg3 source:(id)arg4;
- (id)_dragTypes;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_accessibilityFrameForElement:(id)arg1;
...
- (void)_getEdgeResizingRects:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg1 allowedEdges:(unsigned long long)arg2;
...
- (void)set_beforeTabPickerResponder:(id)arg1;
- (id)tab;
...
- (struct CGImage { }*)_cgImageInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 options:(unsigned int)arg2;
...
- (struct CGSize { double x1; double x2; })_shadowOffsetForOptions:(unsigned long long)arg1;
...
- (id)snapshotFromRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 options:(unsigned long long)arg2;
- (void)updateInDock;

// NSWindow (ResponderDebug)

- (id)_responderDebugDescription;

// NSWindow (SafariNSWindowExtras)

- (struct CGPoint { double x1; double x2; })_convertPointFromScreen:(struct CGPoint { double x1; double x2; })arg1;
...
// NSWindow (DebugHierarchyAdditions)
...
// NSWindow (ABViewAdditions)

- (void)com_apple_addressBook_dumpResponderChain:(id)arg1;

// Image: /System/Library/Frameworks/Quartz.framework/Versions/A/Frameworks/ImageKit.framework/Versions/A/ImageKit

// NSWindow (IKPTAdditions)

- (void)ikSetupWhiteBackground;

// NSWindow (IKPictureTakerAdditions)

- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })IKIPFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 constrainedToScreen:(id)arg2;
- (void)IKIPSetFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 constrainedToScreen:(id)arg2;
- (void)IKIPSetFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 constrainedToScreen:(id)arg2 display:(BOOL)arg3 animate:(BOOL)arg4;

// Image: /System/Library/Frameworks/Quartz.framework/Versions/A/Frameworks/QuickLookUI.framework/Versions/A/QuickLookUI

// NSWindow (QLPreviewPanelAdditions)

- (id)_qlControllerCandidateForPreviewPanel:(id)arg1;
- (BOOL)_qlIgnoreWindowForPreviewPanel:(id)arg1;

// NSWindow (QLPreviewPanelInvisibility)

- (BOOL)ql_isDesktopWindow;

// NSWindow (QuickLookDeferred)
...
// NSWindow (ViewBridgeService)

- (int)accessibilityPresenterProcessIdentifier;
- (void)scrollWheel:(id)arg1;
- (void)setViewBridgeBecomingChild:(BOOL)arg1;
- (BOOL)viewBridgeBecomingChild;

// NSWindow (ViewBridgeSwizzle)

- (void)_addViewServiceNameToTitleOfColorPanel:(long long)arg1;
- (void)_beginSheet:(id)arg1 isCritical:(BOOL)arg2 completionHandler:(id)arg3;
- (id)_localizedInfoDictionaryObjectForKey:(id)arg1 ifAvailableFromBundle:(id)arg2;
- (void)beginLocalSheet:(id)arg1 completionHandler:(id)arg2 isCritical:(BOOL)arg3;
...
- (void)swizzledBeginCriticalSheet:(id)arg1 completionHandler:(id)arg2;
- (void)swizzledBeginSheet:(id)arg1 completionHandler:(id)arg2;
- (BOOL)swizzledCanBecomeKeyWindow;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })swizzledConstrainFrameRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 toScreen:(id)arg2;
- (void)swizzledDragWindowRelativeToMouseDown:(struct CGPoint { double x1; double x2; })arg1;
...
- (void)swizzledSetCursorForMouseLocation:(struct CGPoint { double x1; double x2; })arg1;
- (void)swizzledSetEventMask:(unsigned long long)arg1;
- (void)swizzledSetFrameCommon:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 display:(BOOL)arg2 stashSize:(BOOL)arg3;
