...
+ (void)requestViewControllerForPopover:(BOOL)arg1 withItem:(id)arg2 options:(unsigned long long)arg3 sharingServiceParameters:(id)arg4 connectionHandler:(id)arg5;
