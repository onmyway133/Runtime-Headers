...
@interface NSCollectionView : NSView <DebugHierarchyObject, NSDraggingDestination, NSDraggingSource> {
...
@property (atomic, readwrite) <NSCollectionViewPrefetching> *prefetchDataSource;
...
- (void)_restoreFrameBeforeRestoringScrollPosition:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
...
// NSCollectionView (_NSItemForRepresentedObject)
...
// NSCollectionView (DebugHierarchyAdditions)

- (id)debugHierarchyPropertyDescriptions;

// NSCollectionView (DebugHierarchyHelpers)

- (id)__dbg_primaryBackgroundColor;
- (id)__dbg_secondaryBackgroundColor;
