...
- (BOOL)_hitTestForTouch:(id)arg1 inRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 ofView:(id)arg3;
...
// NSCell (QTHUDCellFocusRing)

- (BOOL)QTHUD_shouldShowFocusRing;

// NSCell (QTHUDCellUpdating)
