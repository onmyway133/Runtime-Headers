...
@property (atomic, readonly) BOOL allowsAutomaticShareMenu;
...
- (void)_recursivelyEnumerateMenuItemsStartingFromMenu:(id)arg1 usingBlock:(id)arg2;
...
- (void)_getAutoreopenRecordForDocument:(id)arg1 withoutException:(BOOL)arg2 queue:(id)arg3 completionHandler:(id)arg4;
