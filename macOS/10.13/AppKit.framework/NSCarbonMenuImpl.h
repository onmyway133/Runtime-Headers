...
- (void)_menuItem:(id)arg1 atIndex:(unsigned long long)arg2 didChangeImageSizeFrom:(struct CGSize { double x1; double x2; })arg3 to:(struct CGSize { double x1; double x2; })arg4;
