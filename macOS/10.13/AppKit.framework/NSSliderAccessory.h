...
@property (atomic, readonly, copy) NSImage *_image;
...
@property (atomic, readwrite) <NSSliderAccessoryContainer> *container;
...
@property (atomic, readonly) BOOL repeatsOnLongPress;
