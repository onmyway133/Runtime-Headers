...
@property (nonatomic, readwrite) <MPRemoteCommandDelegate_Internal> *commandCenterDelegate;
@property (nonatomic, readwrite) <MPRemoteCommandDelegate_Private> *delegate;
...
@property (getter=isObserving, nonatomic, readwrite) BOOL observing;
