...
@property (atomic, readwrite) struct CGPoint { double x1; double x2; } glyphOrigin;
@property (atomic, readonly) long long numberOfGlyphs;
@property (atomic, readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } typographicBounds;
