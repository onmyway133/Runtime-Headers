...
@property (getter=_initiatedFromReloadData, setter=_setInitiatedFromReloadData:, nonatomic, readwrite) BOOL initiatedFromReloadData;
...
@property (getter=_retainExistingSizingInfoForEstimates, setter=_setRetainExistingSizingInfoForEstimates:, nonatomic, readwrite) BOOL retainExistingSizingInfoForEstimates;
@property (getter=_updateItems, setter=_setUpdateItems:, nonatomic, readwrite) NSArray *updateItems;
