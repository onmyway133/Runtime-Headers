...
@property (atomic, readonly) unsigned long long listOptions;
@property (atomic, readonly, copy) NSString *markerFormat;
@property (atomic, readwrite) long long startingItemNumber;
