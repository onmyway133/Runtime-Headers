...
@property (atomic, readwrite) struct { long long x1; int x2; unsigned int x3; long long x4; } duration;
@property (atomic, readwrite, retain) AVCaptureInput *input;
@property (atomic, readwrite, retain) AVMetadataObject *originalMetadataObject;
@property (atomic, readwrite) struct { long long x1; int x2; unsigned int x3; long long x4; } time;
