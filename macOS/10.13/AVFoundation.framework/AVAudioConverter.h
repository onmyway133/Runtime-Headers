...
@property (nonatomic, readwrite) long long bitRate;
@property (nonatomic, readwrite, retain) NSString *bitRateStrategy;
@property (nonatomic, readwrite, retain) NSArray *channelMap;
@property (nonatomic, readwrite) BOOL dither;
@property (nonatomic, readwrite) BOOL downmix;
@property (nonatomic, readonly) AVAudioFormat *inputFormat;
@property (nonatomic, readwrite, retain) NSData *magicCookie;
@property (nonatomic, readonly) long long maximumOutputPacketSize;
@property (nonatomic, readonly) AVAudioFormat *outputFormat;
@property (nonatomic, readwrite) struct AVAudioConverterPrimeInfo { unsigned int x1; unsigned int x2; } primeInfo;
@property (nonatomic, readwrite) long long primeMethod;
@property (nonatomic, readwrite, retain) NSString *sampleRateConverterAlgorithm;
@property (nonatomic, readwrite) long long sampleRateConverterQuality;

- (id)channelMap;
- (long long)convertToBuffer:(id)arg1 error:(id*)arg2 withInputFromBlock:(id)arg3;
