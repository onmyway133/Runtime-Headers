...
// AVVideoComposition (AVVideoCompositionColorimetery)

- (id)colorPrimaries;
- (id)colorTransferFunction;
- (id)colorYCbCrMatrix;

// AVVideoComposition (AVVideoCompositionColorimeteryUtilities)
...
// AVVideoComposition (AVVideoCompositionFiltering)
