...
@property (atomic, readonly) struct { long long x1; int x2; unsigned int x3; long long x4; } duration;
@property (atomic, readonly) struct { long long x1; int x2; unsigned int x3; long long x4; } time;
