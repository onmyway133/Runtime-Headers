...
@property (nonatomic, readwrite) unsigned int outputBitsPerChannel;
@property (nonatomic, readwrite) unsigned int outputChannelCount;
@property (nonatomic, readwrite) unsigned int outputDataRate;
@property (nonatomic, readwrite) unsigned int outputFormat;
@property (nonatomic, readwrite) unsigned int outputFormatFlags;
@property (nonatomic, readwrite) float outputSampleRate;
