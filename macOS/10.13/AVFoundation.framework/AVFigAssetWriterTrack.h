...
@property (getter=isAboveHighWaterLevel, atomic, readonly) BOOL aboveHighWaterLevel;
...
@property (nonatomic, readwrite) struct { long long x1; int x2; unsigned int x3; long long x4; } sampleBufferCoalescingInterval;
