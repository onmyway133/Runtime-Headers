...
@property (atomic, readwrite, copy) id async_initialization;
@property (atomic, readwrite, retain) __NSCFURLSessionConnection *cfConn;
@property (atomic, readwrite, copy) id dataTaskCompletion;
@property (atomic, readonly, copy) NSString *debugDescription;
@property (atomic, readonly, copy) NSString *description;
@property (atomic, readwrite) BOOL didIssueDidFinish;
@property (atomic, readwrite) BOOL didIssueWaitingForConnectivity;
@property (atomic, readonly) unsigned long long hash;
@property (atomic, readwrite, retain) __NSURLSessionLocal *localSession;
@property (atomic, readwrite) BOOL pendingResponseDisposition;
@property (atomic, readwrite) BOOL pendingResponseDisposition_didFinish;
@property (atomic, readonly) Class superclass;
@property (atomic, readwrite) unsigned long long suspendCount;
@property (atomic, readwrite, retain) NSURL *uploadFile;
