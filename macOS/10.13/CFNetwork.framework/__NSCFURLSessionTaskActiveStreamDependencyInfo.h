...
@property (nonatomic, readwrite, retain) NSMutableDictionary *_mainDocumentTaskMimeTypes;
@property (nonatomic, readwrite, retain) NSMutableDictionary *_mainDocumentTaskURLs;
@property (nonatomic, readwrite, retain) NSNumber *_streamID;
