...
@property (atomic, readwrite, copy) NSDictionary *additionalProperties;
...
@property (atomic, readwrite) BOOL respondedToWillBeginDelayedRequestCallback;
@property (atomic, readwrite, copy) NSURLResponse *response;
@property (atomic, readwrite) BOOL resumedAndWaitingForEarliestBeginDate;
