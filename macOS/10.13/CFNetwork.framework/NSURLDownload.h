...
@property (atomic, readwrite) BOOL deletesFileUponFailure;
@property (atomic, readonly, copy) NSString *description;
@property (atomic, readonly) unsigned long long hash;
@property (atomic, readonly, copy) NSURLRequest *request;
@property (atomic, readonly, copy) NSData *resumeData;
...
// NSURLDownload (NSURLAuthenticationChallengeSender)
