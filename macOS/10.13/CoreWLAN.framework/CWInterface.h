...
@property (atomic, readwrite) NSObject<OS_dispatch_queue> *eventQueue;
...
@property (atomic, readonly) BOOL powerRX;
@property (atomic, readonly) BOOL powerSaveModeEnabled;
@property (atomic, readonly) BOOL powerTX;
...
- (BOOL)twoGHzChainDisabledAndReturnReassocRequired:(BOOL*)arg1 error:(id*)arg2;
