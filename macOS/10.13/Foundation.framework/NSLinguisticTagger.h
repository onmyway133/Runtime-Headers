...
@property (atomic, readonly, copy) NSString *dominantLanguage;
@property (atomic, readwrite, retain) NSString *string;
@property (atomic, readonly, copy) NSArray *tagSchemes;
...
+ (void)enumerateTagsForString:(id)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 unit:(long long)arg3 scheme:(id)arg4 options:(unsigned long long)arg5 orthography:(id)arg6 usingBlock:(id)arg7;
...
- (void)_enumerateTagsInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 scheme:(id)arg2 options:(unsigned long long)arg3 usingBlock:(id)arg4;
...
- (void)enumerateTagsInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 unit:(long long)arg2 scheme:(id)arg3 options:(unsigned long long)arg4 usingBlock:(id)arg5;
