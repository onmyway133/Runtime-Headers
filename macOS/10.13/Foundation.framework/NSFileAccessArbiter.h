...
@property (atomic, readonly) NSXPCConnection *superarbitrationConnection;
...
- (void)getItemHasPresentersAtURL:(id)arg1 completionHandler:(id)arg2;
...
// NSFileAccessArbiter (FileProvider)
