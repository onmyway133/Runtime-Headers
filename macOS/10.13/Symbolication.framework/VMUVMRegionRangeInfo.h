...
@property (atomic, readonly) struct _VMURange { unsigned long long x1; unsigned long long x2; } range;
@property (atomic, readwrite) unsigned long long size;
@property (atomic, readwrite) unsigned long long stackIdentifier;
@property (atomic, readwrite) unsigned int userTag;
