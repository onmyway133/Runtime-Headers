...
@property (nonatomic, readwrite) unsigned long long snapshotMachTime;
@property (nonatomic, readwrite, retain) <VMUStackLogReader> *stackLogReader;
...
- (void)dealloc;
- (id)debugTimer;
- (unsigned int)enumerateReferencesFromDataRegion:(id)arg1 atGlobalSymbol:(id)arg2 withBlock:(id)arg3;
