...
@property (nonatomic, readwrite, retain) VMUClassInfoMap *indexedClassInfos;
...
- (unsigned int)enumerateObjectsContainedInCollection:(unsigned int)arg1 withBlock:(id)arg2;
...
// VMUObjectGraph (UsefulAlgorithms)
