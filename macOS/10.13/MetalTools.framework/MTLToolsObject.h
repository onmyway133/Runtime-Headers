...
@property (nonatomic, readwrite, retain) id baseObject;
@property (nonatomic, readonly) <MTLDevice> *device;
@property (nonatomic, readwrite) struct ILayerLockingPolicy { int (**x1)(); }*lockingPolicy;
@property (nonatomic, readwrite) MTLToolsPointerArray *tracker;
