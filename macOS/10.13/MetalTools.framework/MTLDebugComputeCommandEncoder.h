...
@interface MTLDebugComputeCommandEncoder : MTLToolsComputeCommandEncoder {
    /* Warning: unhandled struct encoding: '{?="isValid"c"hasBeenUsed"c"type"Q"object"@"baseLevel"Q"bufferLength"Q"bufferOffset"Q"threadgroupMemoryLength"Q"threadgroupMemoryOffset"Q"hasLodClamp"c"lodMinClamp"f"lodMaxClamp"f}]' */ struct { 
        BOOL isValid; 
        BOOL hasBeenUsed; 
...
- (void)endEncoding;
- (void)enumerateBuffersUsingBlock:(id)arg1;
- (void)enumerateSamplersUsingBlock:(id)arg1;
- (void)enumerateTexturesUsingBlock:(id)arg1;
- (void)enumerateThreadgroupMemoryLengthsUsingBlock:(id)arg1;
