...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)getComponentUserTags:(id)arg1 reply:(id)arg2;
- (void)getExtensionComponentList:(id)arg1 linkedSDKVersion:(int)arg2 reply:(id)arg3;
- (void)getExtensionIcon:(id)arg1 reply:(id)arg2;
...
- (void)setExtensionComponentList:(id)arg1 linkedSDKVersion:(int)arg2 components:(id)arg3 reply:(id)arg4;
