...
@interface IMKInputSession : NSObject <IMKTextInput, IMKTextInput_FunctionRowUI, IMKUnicodeTextInput, IMKXPCSupport, IMTSMSupport> {
...
@property (atomic, readwrite) BOOL activatePending;
...
@property (nonatomic, readwrite, retain) id touchBarViewController;
...
- (void)imkxpc_dismissFunctionRowItemTextInputViewWithReply:(id)arg1;
...
- (void)imkxpc_presentFunctionRowItemTextInputViewWithEndpoint:(id)arg1 reply:(id)arg2;
...
- (void)presentFunctionRowItemTextInputViewWithEndpoint:(id)arg1 completionHandler:(id)arg2;
...
- (void)setActivatePending:(BOOL)arg1;
