...
@property (nonatomic, readwrite, retain) TXRAssetCatalogFileAttributes *baseFileAttributes;
@property (nonatomic, readwrite) unsigned long long displayColorSpace;
@property (nonatomic, readonly) NSSet *fileAttributesList;
@property (nonatomic, readwrite) unsigned long long graphicsFeatureSet;
@property (nonatomic, readwrite) unsigned long long idiom;
@property (nonatomic, readwrite) unsigned long long memory;
@property (nonatomic, readwrite) unsigned long long mipmapOption;
@property (nonatomic, readwrite) unsigned long long pixelFormat;
@property (nonatomic, readwrite) unsigned long long scaleFactor;
