...
@property (nonatomic, readwrite, retain) NSMutableData *outputBuffer;
@property (nonatomic, readwrite, retain) NSFileHandle *outputFileHandle;
@property (nonatomic, readonly) NSData *stringClosingTagData;
@property (nonatomic, readonly) NSData *stringOpeningTagData;
@property (nonatomic, readwrite, retain) NSMutableString *tabPrefix;
@property (nonatomic, readwrite, retain) NSData *tabPrefixData;
