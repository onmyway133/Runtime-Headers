...
@property (nonatomic, readwrite) <MSVDistributedNotificationObserverDelegate> *delegate;
@property (nonatomic, readonly) NSString *distributedName;
@property (nonatomic, readonly) NSString *localName;
@property (nonatomic, readonly) NSObject<OS_dispatch_queue> *queue;
@property (nonatomic, readwrite, copy) NSDictionary *userInfoForLocalNotification;
