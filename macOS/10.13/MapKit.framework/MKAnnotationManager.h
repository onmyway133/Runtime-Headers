...
@property (nonatomic, readwrite) BOOL annotationRepresentationsAreAddedImmediately;
@property (nonatomic, readonly) NSArray *annotations;
@property (nonatomic, readwrite) <MKAnnotationMarkerContainer> *container;
@property (nonatomic, readwrite) <MKAnnotationManagerDelegate> *delegate;
@property (nonatomic, readwrite) <MKAnnotation> *draggedAnnotation;
