...
@interface MKAnnotationContainerView : NSView <MKAnnotationCalloutControllerDelegate, VKCustomFeatureDataSource, _MKPinAnnotationViewDelegate> {
...
@property (nonatomic, readonly) MKAnnotationCalloutController *calloutController;
...
@property (nonatomic, readwrite) <MKAnnotationContainerViewDelegate> *delegate;
...
@property (nonatomic, readwrite) BOOL suppressCallout;
...
- (struct NSEdgeInsets { double x1; double x2; double x3; double x4; })accessoryPadding;
...
- (void)draggingTouchMovedToPoint:(struct CGPoint { double x1; double x2; })arg1 edgeInsets:(struct NSEdgeInsets { double x1; double x2; double x3; double x4; })arg2;
...
// MKAnnotationContainerView (VKSpaceReserving)
