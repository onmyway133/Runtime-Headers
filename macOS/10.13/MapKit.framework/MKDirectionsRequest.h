...
@property (getter=_additionalTransportTypesRequested, setter=_setAdditionalTransportTypesRequested:, nonatomic, readwrite, retain) NSArray *additionalTransportTypesRequested;
@property (getter=_automobileOptions, setter=_setAutomobileOptions:, nonatomic, readwrite, retain) GEOAutomobileOptions *automobileOptions;
@property (nonatomic, readwrite, retain) MKMapItem *destination;
@property (getter=_includeDistanceInETA, setter=_setIncludeDistanceInETA:, nonatomic, readwrite) BOOL includeDistanceInETA;
@property (getter=_requestMode, setter=_setRequestMode:, nonatomic, readwrite) int requestMode;
@property (nonatomic, readwrite, retain) MKMapItem *source;
@property (getter=_transitOptions, setter=_setTransitOptions:, nonatomic, readwrite, retain) GEOTransitOptions *transitOptions;
@property (getter=_walkingOptions, setter=_setWalkingOptions:, nonatomic, readwrite, retain) GEOWalkingOptions *walkingOptions;
