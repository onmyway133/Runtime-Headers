...
@property (nonatomic, readwrite, retain) MKMapItem *destinationMapItem;
@property (nonatomic, readwrite, retain) MKMapItem *sourceMapItem;
@property (nonatomic, readwrite) unsigned long long transportType;
