...
@property (atomic, readonly) NSString *URLTemplate;
...
@property (nonatomic, readwrite) BOOL canReplaceMapContent;
@property (nonatomic, readonly) struct CLLocationCoordinate2D { double x1; double x2; } coordinate;
@property (atomic, readonly, copy) NSString *debugDescription;
@property (atomic, readonly, copy) NSString *description;
@property (getter=isGeometryFlipped, atomic, readwrite) BOOL geometryFlipped;
@property (atomic, readonly) unsigned long long hash;
@property (atomic, readwrite) long long maximumZ;
@property (atomic, readwrite) long long minimumZ;
