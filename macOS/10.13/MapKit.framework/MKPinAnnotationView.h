...
@property (setter=_setDelegate:, nonatomic, readwrite) <_MKPinAnnotationViewDelegate> *_delegate;
@property (nonatomic, readwrite) BOOL animatesDrop;
@property (nonatomic, readwrite) unsigned long long pinColor;
@property (atomic, readwrite, retain) NSColor *pinTintColor;
...
+ (id)_pinsWithMapType:(unsigned long long)arg1 mapDisplayStyle:(struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; BOOL x5; })arg2 pinColor:(id)arg3;
+ (id)_reuseIdentifier;
