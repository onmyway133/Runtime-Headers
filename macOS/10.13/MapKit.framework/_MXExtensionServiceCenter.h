...
@property (nonatomic, readwrite, copy) NSDictionary *containingAppProxies;
@property (nonatomic, readonly) _MXExtensionProvider *extensionProvider;
@property (nonatomic, readwrite, copy) NSDictionary *extensions;
@property (nonatomic, readwrite, copy) NSDictionary *mapsExtensions;
