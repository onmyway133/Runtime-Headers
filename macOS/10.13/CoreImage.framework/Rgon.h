...
@property (atomic, readwrite) float aspectRatio;
@property (atomic, readwrite) double count;
@property (atomic, readwrite) float currentArea;
@property (atomic, readonly) NSArray *enclosedPoints;
@property (atomic, readwrite) int maxAxisIndex;
@property (atomic, readwrite) long long pointCount;
@property (atomic, readwrite) float*pointerToRgonArray;
@property (atomic, readwrite) float*rgonPtr;
@property (atomic, readwrite) float xmax;
@property (atomic, readwrite) float xmin;
@property (atomic, readwrite) float ymax;
@property (atomic, readwrite) float ymin;
