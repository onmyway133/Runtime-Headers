...
@property (nonatomic, readwrite) CIGVGraph *graph;
...
@property (nonatomic, readwrite) struct __CFString { }*label;
...
@property (atomic, readonly) void*node;
...
@property (nonatomic, readwrite) int shape;
@property (nonatomic, readwrite) struct __CFString { }*title;
