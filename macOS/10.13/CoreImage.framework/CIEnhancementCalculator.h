...
@property (atomic, readwrite) BOOL curvesEnabled;
@property (atomic, readwrite) BOOL faceBalanceEnabled;
@property (atomic, readwrite) BOOL shadowsEnabled;
@property (atomic, readwrite) BOOL vibranceEnabled;
