...
@property (nonatomic, readwrite, copy) NSNumber *inputBackgroundSeparationLikehood;
...
@property (nonatomic, readwrite, retain) CIImage *inputDisparity;
...
@property (nonatomic, readwrite, retain) CIImage *inputFullSizeImage;
...
@property (nonatomic, readwrite, copy) NSNumber *inputMinimumEffectLevel;
