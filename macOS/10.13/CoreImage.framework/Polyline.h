...
@property (atomic, readwrite) struct CGPoint { double x1; double x2; } normV;
@property (atomic, readwrite) unsigned int nsegs;
@property (atomic, readwrite) double s0;
@property (atomic, readwrite) double s1;
@property (atomic, readwrite) double seglength;
@property (atomic, readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } xyBoundsRect;
