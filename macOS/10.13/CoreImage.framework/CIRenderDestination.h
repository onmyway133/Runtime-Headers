...
@property (atomic, readwrite) unsigned long long alphaMode;
@property (nonatomic, readwrite, retain) CIBlendKernel *blendKernel;
@property (atomic, readwrite) BOOL blendsInDestinationColorSpace;
@property (getter=isClamped, atomic, readwrite) BOOL clamped;
@property (nonatomic, readwrite) struct CGColorSpace { }*colorSpace;
@property (getter=isDithered, atomic, readwrite) BOOL dithered;
...
- (/* Warning: unhandled struct encoding: '{CIRenderDestinationInternal=^{RenderDestination}QQi^{CGColorSpace}Qccicc@}' */ struct CIRenderDestinationInternal { struct RenderDestination {} *x1; unsigned long long x2; unsigned long long x3; int x4; struct CGColorSpace {} *x5; unsigned long long x6; BOOL x7; BOOL x8; int x9; BOOL x10; BOOL x11; id x12; }*)_internalRepresentation;
...
- (id)initWithWidth:(unsigned long long)arg1 height:(unsigned long long)arg2 pixelFormat:(unsigned int)arg3 colorSpace:(struct CGColorSpace { }*)arg4 pixelBufferProvider:(id)arg5;
- (id)initWithWidth:(unsigned long long)arg1 height:(unsigned long long)arg2 pixelFormat:(unsigned int)arg3 colorSpace:(struct CGColorSpace { }*)arg4 surfaceProvider:(id)arg5;
- (id)initWithWidth:(unsigned long long)arg1 height:(unsigned long long)arg2 pixelFormat:(unsigned long long)arg3 commandBuffer:(id)arg4 mtlTextureProvider:(id)arg5;
- (BOOL)isClamped;
- (BOOL)isDithered;
- (BOOL)isFlipped;
