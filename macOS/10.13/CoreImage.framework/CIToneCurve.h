...
@property (nonatomic, readwrite, copy) CIVector *inputPoint0;
@property (nonatomic, readwrite, copy) CIVector *inputPoint1;
@property (nonatomic, readwrite, copy) CIVector *inputPoint2;
@property (nonatomic, readwrite, copy) CIVector *inputPoint3;
@property (nonatomic, readwrite, copy) CIVector *inputPoint4;
