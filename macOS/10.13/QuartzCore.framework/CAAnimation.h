...
@property (atomic, readwrite) BOOL QCSCN_usesSceneTimeBase;
@property (nonatomic, readwrite, copy) id _appkit_animationDidStopHandler;
@property (atomic, readwrite) long long _mapkit_ID;
...
@property (atomic, readwrite) BOOL discretizesTime;
@property (atomic, readwrite) double duration;
@property (getter=isEnabled, atomic, readwrite) BOOL enabled;
@property (atomic, readwrite) double fadeInDuration;
@property (atomic, readwrite) double fadeOutDuration;
...
@property (atomic, readwrite) BOOL usesSceneTimeBase;
...
- (void)setQCSCN_usesSceneTimeBase:(BOOL)arg1;
