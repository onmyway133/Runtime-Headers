...
@property (atomic, readwrite, retain) id colorMap;
@property (atomic, readwrite, copy) NSArray *colors;
@property (atomic, readwrite) struct CGPoint { double x1; double x2; } endPoint;
@property (atomic, readwrite, copy) NSArray *locations;
