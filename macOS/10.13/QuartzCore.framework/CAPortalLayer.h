...
@property (atomic, readwrite) BOOL hidesSourceLayer;
@property (atomic, readwrite) BOOL matchesOpacity;
@property (atomic, readwrite) BOOL matchesPosition;
@property (atomic, readwrite) BOOL matchesTransform;
