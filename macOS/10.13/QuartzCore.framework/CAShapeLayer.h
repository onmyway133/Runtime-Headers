...
@property (atomic, readwrite, copy) NSString *fillRule;
@property (atomic, readwrite, copy) NSString *lineCap;
@property (atomic, readwrite, copy) NSArray *lineDashPattern;
@property (atomic, readwrite) double lineDashPhase;
@property (atomic, readwrite, copy) NSString *lineJoin;
...
@property (atomic, readwrite) struct CGColor { }*strokeColor;
@property (atomic, readwrite) double strokeEnd;
@property (atomic, readwrite) double strokeStart;
