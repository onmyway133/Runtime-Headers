...
@property (atomic, readonly) int blendMode;
...
@property (atomic, readonly) double fillOpacity;
@property (atomic, readonly) BOOL hasLayerMask;
@property (atomic, readonly) BOOL hasVectorMask;
@property (atomic, readonly) double opacity;
@property (atomic, readonly) BOOL visibility;
