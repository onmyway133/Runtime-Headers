...
@property (nonatomic, readonly) id changesBlock;
...
- (id)changesBlock;
- (id)initWithObservedObject:(id)arg1 observer:(id)arg2 keyPaths:(id)arg3 retainingObservedObject:(BOOL)arg4 options:(unsigned long long)arg5 changesBlock:(id)arg6;
- (id)keyPaths;
