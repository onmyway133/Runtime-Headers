...
@property (nonatomic, readwrite, retain) CALayer *rootLayer;
@property (nonatomic, readonly, copy) NSString *state;
@property (nonatomic, readonly) CAStateController *stateController;
@property (atomic, readonly) Class superclass;
@property (nonatomic, readwrite) struct CGSize { double x1; double x2; } targetSize;
@property (nonatomic, readwrite) struct CGSize { double x1; double x2; } unscaledSize;
