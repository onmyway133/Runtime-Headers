...
@interface AVFunctionBarAudioCaptureDeviceSelectionButtonViewController : NSViewController {
    ...
    <AVFunctionBarAudioCaptureDeviceSelectionButtonViewControllerDelegate> * _delegate;
}

@property (atomic, readwrite, retain) <AVFunctionBarRecordingControlsControllingInternal> *captureController;
@property (nonatomic, readwrite) <AVFunctionBarAudioCaptureDeviceSelectionButtonViewControllerDelegate> *delegate;
