...
@interface AVTouchBarPlaybackControlsViewController : NSViewController {
    ...
    <AVTouchBarPlaybackControlsControllingInternal><AVTouchBarTrackControlling><AVTimeControlling> * _playerController;
...
@property (atomic, readwrite, retain) <AVTouchBarPlaybackControlsControllingInternal><AVTouchBarTrackControlling><AVTimeControlling> *playerController;
