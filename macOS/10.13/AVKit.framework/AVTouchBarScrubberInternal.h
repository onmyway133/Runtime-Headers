...
@interface AVTouchBarScrubberInternal : NSView <NSAccessibilitySlider> {
    ...
    <AVTouchBarScrubberDelegateInternal> * _delegate;
...
@property (nonatomic, readwrite) <AVTouchBarScrubberDelegateInternal> *delegate;
...
@property (nonatomic, readwrite, retain) AVTouchBarTrackView *trackView;
