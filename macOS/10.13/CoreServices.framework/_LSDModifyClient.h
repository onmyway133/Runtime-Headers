...
- (void)registerContainerURL:(id)arg1 completionHandler:(id)arg2;
...
- (void)unregisterBundleUnit:(unsigned int)arg1 options:(unsigned int)arg2 completionHandler:(id)arg3;
- (void)unregisterExtensionPoint:(id)arg1 withVersion:(id)arg2 completionHandler:(id)arg3;
