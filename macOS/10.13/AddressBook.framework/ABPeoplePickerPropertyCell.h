...
@property (nonatomic, readwrite, copy) NSIndexSet *selectedSubrowIndexes;
...
- (void)_drawSelection:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 selected:(BOOL)arg2 inView:(id)arg3 withRoundedLeftEdges:(int)arg4;
...
- (id)selectedSubrowIndexes;
- (void)setSelectedSubrowIndexes:(id)arg1;
- (id)tooltipText;
