...
- (const struct MTLFunctionData { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned short x5; unsigned short x6; unsigned short x7; unsigned short x8; struct { unsigned char x_9_1_1[32]; } x9; unsigned char x10; unsigned char x11; unsigned int x12 : 2; unsigned int x13 : 6; }*)functionData;
- (id)initWithName:(id)arg1 type:(unsigned long long)arg2 libraryData:(struct MTLLibraryData { int (**x1)(); int x2; id x3; }*)arg3 functionData:(struct MTLFunctionData { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned short x5; unsigned short x6; unsigned short x7; unsigned short x8; struct { unsigned char x_9_1_1[32]; } x9; unsigned char x10; unsigned char x11; unsigned int x12 : 2; unsigned int x13 : 6; }*)arg4 device:(id)arg5;
- (void)initializePrivateMetadata;
- (void)initializePublicMetadata;
- (long long)lineNumber;
- (BOOL)needsFunctionConstantValues;
- (void)newSpecializedFunctionWithConstants:(id)arg1 functionCache:(id)arg2 completionHandler:(id)arg3;
