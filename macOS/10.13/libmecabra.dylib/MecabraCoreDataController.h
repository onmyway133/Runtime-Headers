...
@property (nonatomic, readwrite, retain) NSURL *localURL;
...
@property (nonatomic, readwrite, retain) NSURL *storeURL;
@property (nonatomic, readwrite, retain) NSArray *storedElementsForMerge;
