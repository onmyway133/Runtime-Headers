...
@property (nonatomic, readwrite, copy) NSURL *URLValue;
@property (nonatomic, readwrite) struct CGColor { }*color;
@property (nonatomic, readwrite) void float2Value;
@property (nonatomic, readwrite) void float3Value;
@property (nonatomic, readwrite) void float4Value;
@property (nonatomic, readwrite) float floatValue;
@property (nonatomic, readwrite) float luminance;
@property (nonatomic, readwrite) struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; } matrix4x4;
@property (nonatomic, readwrite, copy) NSString *name;
@property (nonatomic, readwrite) unsigned long long semantic;
@property (nonatomic, readwrite, copy) NSString *stringValue;
@property (nonatomic, readwrite, retain) MDLTextureSampler *textureSamplerValue;
