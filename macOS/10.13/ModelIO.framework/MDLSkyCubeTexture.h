...
@property (nonatomic, readwrite) float gamma;
@property (nonatomic, readwrite) float groundAlbedo;
@property (nonatomic, readwrite) struct CGColor { }*groundColor;
@property (nonatomic, readwrite) void highDynamicRangeCompression;
@property (nonatomic, readwrite) float horizonElevation;
@property (nonatomic, readwrite) float saturation;
@property (nonatomic, readwrite) float sunAzimuth;
@property (nonatomic, readwrite) float sunElevation;
@property (nonatomic, readwrite) float turbidity;
@property (nonatomic, readwrite) float upperAtmosphereScattering;
