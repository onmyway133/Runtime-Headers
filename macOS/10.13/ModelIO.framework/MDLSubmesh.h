...
@property (nonatomic, readwrite, retain) NSArray *faceIndexing;
...
@property (nonatomic, readwrite, retain) MDLMaterial *material;
@property (nonatomic, readwrite, copy) NSString *name;
@property (nonatomic, readwrite, retain) MDLSubmeshTopology *topology;
