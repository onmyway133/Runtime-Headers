...
@property (nonatomic, readwrite, copy) NSMutableArray *submeshes;
@property (nonatomic, readwrite, retain) NSArray *vertexBuffers;
@property (nonatomic, readwrite) unsigned long long vertexCount;
