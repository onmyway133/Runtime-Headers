...
- (struct CGSize { double x1; double x2; })renderingAspectRatio;
- (id)renderingContext;
- (void)setAsynchronous:(BOOL)arg1;
- (void)setEvent:(id)arg1;
- (void)setInputValuesWithPropertyList:(id)arg1;
- (void)setMouseLocation:(struct CGPoint { double x1; double x2; })arg1;
- (void)setObservationInfo:(void*)arg1;
- (void)setRenderingAspectRatio:(struct CGSize { double x1; double x2; })arg1;
