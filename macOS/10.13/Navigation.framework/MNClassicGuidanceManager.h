...
@property (nonatomic, readwrite) struct { long long x1; double x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; int x7; int x8; } currentInstructionOptions;
@property (nonatomic, readwrite, retain) NSString *currentRoadName;
@property (nonatomic, readwrite, retain) NSString *currentShieldText;
@property (atomic, readonly, copy) NSString *debugDescription;
@property (nonatomic, readwrite) <MNGuidanceManagerDelegate> *delegate;
