...
@property (nonatomic, readwrite, retain) <GEOServerFormattedString> *countStopsFormattedString;
@property (nonatomic, readwrite, retain) <GEOServerFormattedString> *departureBarInstruction;
@property (atomic, readwrite, copy) NSArray *majorFormattedInstruction;
@property (atomic, readwrite, copy) NSArray *minorFormattedInstruction;
@property (atomic, readwrite, copy) NSArray *tertiaryFormattedInstruction;
