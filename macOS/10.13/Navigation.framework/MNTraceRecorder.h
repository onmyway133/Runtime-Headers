...
@property (nonatomic, readwrite) <MNTraceRecorderBackgroundGuard> *backgroundGuardDelegate;
@property (nonatomic, readwrite) BOOL copyToCrashReporterDirectory;
@property (atomic, readonly, copy) NSString *debugDescription;
@property (atomic, readonly, copy) NSString *description;
@property (atomic, readonly) unsigned long long hash;
@property (nonatomic, readonly) NSDate *recordingStartTime;
@property (atomic, readonly) Class superclass;
@property (nonatomic, readwrite, copy) id timeSinceRecordingBeganHandler;
...
- (void)startWritingTraceToFileAtPath:(id)arg1 shouldPrepareStatements:(BOOL)arg2 completion:(id)arg3;
- (void)startWritingTraceToFileIfNecessaryWithCompletion:(id)arg1;
- (void)startWritingTraceToFileWithCompletion:(id)arg1;
