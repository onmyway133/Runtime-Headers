...
@property (nonatomic, readwrite, copy) id decryptHandler;
@property (nonatomic, readwrite, copy) id encryptHandler;
@property (nonatomic, readwrite, copy) NSDictionary *schema;
