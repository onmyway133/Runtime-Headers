...
@property (nonatomic, readwrite) double connectTimeoutSecs;
@property (nonatomic, readwrite) double dataTimeoutSecs;
@property (nonatomic, readwrite) int defaultPort;
@property (nonatomic, readwrite, retain) CUBonjourDevice *destinationBonjour;
@property (nonatomic, readwrite, copy) NSString *destinationString;
...
@property (nonatomic, readwrite, copy) id serverInvalidationHandler;
...
- (int)socketFD;
- (void)writeEndOfDataWithCompletion:(id)arg1;
