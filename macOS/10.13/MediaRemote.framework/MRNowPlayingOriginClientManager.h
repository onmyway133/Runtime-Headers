...
- (void)clientRequestsForUnresolvedPlayerPath:(void*)arg1 completion:(id)arg2;
- (void)dealloc;
- (id)init;
- (id)localOriginClient;
- (void)localOriginClientRequests:(id)arg1;
- (id)originClientForOrigin:(void*)arg1;
- (id)originClientForPlayerPath:(void*)arg1;
- (id)originClientRequestsForPlayerPath:(void*)arg1;
- (void)originClientRequestsForUnresolvedPlayerPath:(void*)arg1 completion:(id)arg2;
- (id)playerClientForPlayerPath:(void*)arg1;
- (id)playerClientRequestsForPlayerPath:(void*)arg1;
- (void)playerClientRequestsForUnresolvedPlayerPath:(void*)arg1 completion:(id)arg2;
