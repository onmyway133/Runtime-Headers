...
@property (nonatomic, readwrite) double buttonAUpDelay;
@property (nonatomic, readwrite, retain) GCController *controller;
@property (nonatomic, readwrite) <MREmulatedGameControllerDelegate> *delegate;
