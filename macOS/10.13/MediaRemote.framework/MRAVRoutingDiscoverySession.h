...
@property (nonatomic, readwrite, copy) NSArray *availableEndpoints;
@property (nonatomic, readonly) NSArray *availableOutputDevices;
@property (nonatomic, readwrite) unsigned int discoveryMode;
...
- (id)addEndpointsChangedCallback:(id)arg1;
- (id)addOutputDevicesChangedCallback:(id)arg1;
