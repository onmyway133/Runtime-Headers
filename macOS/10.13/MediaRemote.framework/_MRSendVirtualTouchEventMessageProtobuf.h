...
@property (nonatomic, readwrite, retain) _MRVirtualTouchEventProtobuf *event;
@property (nonatomic, readonly) BOOL hasEvent;
@property (nonatomic, readwrite) BOOL hasVirtualDeviceID;
@property (nonatomic, readwrite) unsigned long long virtualDeviceID;
