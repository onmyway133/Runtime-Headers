...
@property (nonatomic, readwrite, retain) NSString *authenticationToken;
@property (nonatomic, readwrite, retain) _MRClientUpdatesConfigurationProtobuf *clientUpdatesConfigMessage;
@property (nonatomic, readwrite, retain) _MRSetConnectionStateMessageProtobuf *connectionState;
@property (nonatomic, readwrite, retain) _MRPlaybackQueueProtobuf *contentItemsChangedNotificationMessage;
@property (nonatomic, readwrite, retain) _MRCryptoPairingMessageProtobuf *cryptoPairingMessage;
@property (nonatomic, readwrite, retain) _MRDeviceInfoMessageProtobuf *deviceInfoMessage;
@property (nonatomic, readwrite) unsigned int errorCode;
@property (nonatomic, readwrite, retain) _MRGameControllerMessageProtobuf *gameController;
@property (nonatomic, readwrite, retain) _MRGameControllerPropertiesMessageProtobuf *gameControllerProperties;
@property (nonatomic, readwrite, retain) _MRGenericMessageProtobuf *genericMessage;
@property (nonatomic, readwrite, retain) _MRGetKeyboardSessionProtobuf *getKeyboardMessage;
@property (nonatomic, readwrite, retain) _MRGetStateMessageProtobuf *getStateMessage;
@property (nonatomic, readwrite, retain) _MRGetVoiceInputDevicesMessageProtobuf *getVoiceInputDevicesMessage;
@property (nonatomic, readwrite, retain) _MRGetVoiceInputDevicesResponseMessageProtobuf *getVoiceInputDevicesResponseMessage;
...
@property (nonatomic, readwrite, retain) _MRKeyboardMessageProtobuf *keyboardMessage;
@property (nonatomic, readwrite, retain) _MRAVModifyOutputContextRequestProtobuf *modifyOutputContextRequestMessage;
@property (nonatomic, readwrite, retain) _MRNotificationMessageProtobuf *notificationMessage;
@property (nonatomic, readwrite, retain) _MRPlaybackQueueRequestProtobuf *playbackQueueRequest;
@property (nonatomic, readwrite, retain) _MRSetReadyStateMessageProtobuf *readyStateMessage;
@property (nonatomic, readwrite, retain) _MRRegisterForGameControllerEventsMessageProtobuf *registerForGameControllerEvents;
@property (nonatomic, readwrite, retain) _MRRegisterGameControllerMessageProtobuf *registerGameController;
@property (nonatomic, readwrite, retain) _MRRegisterGameControllerResponseMessageProtobuf *registerGameControllerResponse;
@property (nonatomic, readwrite, retain) _MRRegisterHIDDeviceMessageProtobuf *registerHIDDeviceMessage;
@property (nonatomic, readwrite, retain) _MRRegisterHIDDeviceResultMessageProtobuf *registerHIDDeviceResultMessage;
@property (nonatomic, readwrite, retain) _MRRegisterVoiceInputDeviceMessageProtobuf *registerVoiceInputDeviceMessage;
@property (nonatomic, readwrite, retain) _MRRegisterVoiceInputDeviceResponseMessageProtobuf *registerVoiceInputDeviceResponseMessage;
@property (nonatomic, readwrite, retain) _MRSendButtonEventMessageProtobuf *sendButtonEventMessage;
@property (nonatomic, readwrite, retain) _MRSendCommandMessageProtobuf *sendCommandMessage;
@property (nonatomic, readwrite, retain) _MRSendCommandResultMessageProtobuf *sendCommandResultMessage;
@property (nonatomic, readwrite, retain) _MRSendHIDEventMessageProtobuf *sendHIDEventMessage;
@property (nonatomic, readwrite, retain) _MRSendHIDReportMessageProtobuf *sendHIDReportMessage;
@property (nonatomic, readwrite, retain) _MRSendLyricsEventMessageProtobuf *sendLyricsEventMessage;
@property (nonatomic, readwrite, retain) _MRSendPackedVirtualTouchEventMessageProtobuf *sendPackedVirtualTouchEventMessage;
@property (nonatomic, readwrite, retain) _MRSendVirtualTouchEventMessageProtobuf *sendVirtualTouchEventMessage;
@property (nonatomic, readwrite, retain) _MRSendVoiceInputMessageProtobuf *sendVoiceInputMessage;
@property (nonatomic, readwrite, retain) _MRSetArtworkMessageProtobuf *setArtworkMessage;
@property (nonatomic, readwrite, retain) _MRSetHiliteModeMessageProtobuf *setHiliteModeMessage;
@property (nonatomic, readwrite, retain) _MRSetNowPlayingClientMessageProtobuf *setNowPlayingClientMessage;
@property (nonatomic, readwrite, retain) _MRSetNowPlayingPlayerMessageProtobuf *setNowPlayingPlayerMessage;
@property (nonatomic, readwrite, retain) _MRSetRecordingStateMessageProtobuf *setRecordingStateMessage;
@property (nonatomic, readwrite, retain) _MRSetStateMessageProtobuf *setStateMessage;
@property (nonatomic, readwrite, retain) _MRTextInputMessageProtobuf *textInputMessage;
@property (nonatomic, readwrite) unsigned long long timestamp;
@property (nonatomic, readwrite, retain) _MRTransactionMessageProtobuf *transactionPackets;
@property (nonatomic, readwrite) int type;
@property (nonatomic, readwrite, retain) _MRUnregisterGameControllerMessageProtobuf *unregisterGameController;
@property (nonatomic, readwrite, retain) _MRVolumeControlAvailabilityProtobuf *volumeControlAvailabilityMessage;
@property (nonatomic, readwrite, retain) _MRWakeDeviceMessageProtobuf *wakeDeviceMessage;
