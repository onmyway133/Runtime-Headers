...
@property (nonatomic, readwrite) unsigned int awdlVersion;
@property (nonatomic, readwrite) unsigned int bluetoothDiscovery;
@property (nonatomic, readwrite) unsigned int bonjourDiscovery;
@property (nonatomic, readwrite) unsigned int bonjourResolveComplete;
@property (nonatomic, readwrite) unsigned int bonjourTXTRecordDiscovery;
...
@property (nonatomic, readwrite) BOOL hasAwdlVersion;
@property (nonatomic, readwrite) BOOL hasBluetoothDiscovery;
@property (nonatomic, readwrite) BOOL hasBonjourDiscovery;
@property (nonatomic, readwrite) BOOL hasBonjourResolveComplete;
@property (nonatomic, readwrite) BOOL hasBonjourTXTRecordDiscovery;
@property (nonatomic, readonly) BOOL hasBrowserID;
@property (nonatomic, readwrite) BOOL hasErrorCode;
@property (nonatomic, readonly) BOOL hasErrorDomain;
@property (nonatomic, readwrite) BOOL hasIdentityQueryComplete;
...
@property (nonatomic, readwrite) BOOL hasTcpConnectionComplete;
@property (nonatomic, readwrite) BOOL hasTimestamp;
@property (nonatomic, readwrite) BOOL hasTlsHandshakeComplete;
@property (nonatomic, readwrite) BOOL hasTotalDiscovery;
@property (nonatomic, readwrite) BOOL hasVerifiableIdentity;
@property (nonatomic, readwrite) unsigned int identityQueryComplete;
@property (nonatomic, readwrite, retain) NSString *modelCode;
@property (nonatomic, readwrite, retain) NSString *modelName;
@property (nonatomic, readwrite) unsigned int platform;
@property (nonatomic, readwrite) int rssi;
@property (nonatomic, readwrite, retain) NSString *sessionID;
@property (nonatomic, readwrite) unsigned int tcpConnectionComplete;
@property (nonatomic, readwrite) unsigned long long timestamp;
@property (nonatomic, readwrite) unsigned int tlsHandshakeComplete;
@property (nonatomic, readwrite) unsigned int totalDiscovery;
@property (nonatomic, readwrite) BOOL verifiableIdentity;
