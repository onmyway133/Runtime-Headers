...
@property (nonatomic, readwrite) int deviceRole;
@property (nonatomic, readwrite) int deviceSide;
...
@property (nonatomic, readwrite) int primaryLocation;
@property (nonatomic, readwrite) int rssi;
@property (nonatomic, readwrite) int secondaryLocation;
