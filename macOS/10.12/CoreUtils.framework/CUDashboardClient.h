...
@property (nonatomic, readwrite, retain) NSString *server;
...
- (int)logv:(const char *)arg1 args:(struct __va_list_tag { unsigned int x1; unsigned int x2; void *x3; void *x4; })arg2;
- (id)server;
