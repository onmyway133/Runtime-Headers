...
@property (nonatomic, readwrite, copy) NSData *aad;
@property (nonatomic, readwrite) unsigned long long authTagLength;
@property (nonatomic, readwrite, copy) NSData *data;
@property (nonatomic, readwrite, copy) NSData *nonce;
