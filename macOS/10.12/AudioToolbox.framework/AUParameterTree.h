...
@property (nonatomic, readwrite) AUAudioUnit_XH *_auXH;
@property (nonatomic, readwrite) BOOL _autoCreatedForV2AU;
@property (nonatomic, readwrite) BOOL _suppressObserverCallbacks;
@property (nonatomic, readwrite) /* Warning: unhandled struct encoding: '{vector<AddressToParameter' */ struct  addrToParamIndex; /* unknown property attribute:  std::__1::allocator<AddressToParameter> >=^{AddressToParameter}}} */
@property (nonatomic, readwrite) int numRecorders;
@property (nonatomic, readonly) NSObject<OS_dispatch_queue> *observationQueue;
@property (nonatomic, readwrite) /* Warning: unhandled struct encoding: '{AUObserverController=@@@B{set<AUObserverController::AddressOriginator' */ struct *observerController; /* unknown property attribute:  std::__1::allocator<ParameterAutomationEvent> >=^{ParameterAutomationEvent}}}} */
@property (nonatomic, readwrite) struct AURemoteParameterObserver { }*remoteObserverToken;
@property (nonatomic, readwrite) <_AURemoteParameterSynchronization> *remoteParameterSynchronizer;
@property (nonatomic, readwrite) struct AURemoteParameterObserver { }*remoteRecorderToken;
