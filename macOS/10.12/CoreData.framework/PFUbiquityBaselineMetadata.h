...
@property (atomic, readonly) NSString *authorPeerID;
@property (atomic, readonly) PFUbiquityKnowledgeVector *knowledgeVector;
@property (atomic, readonly) NSString *modelVersionHash;
@property (atomic, readonly) NSDictionary *peerRanges;
