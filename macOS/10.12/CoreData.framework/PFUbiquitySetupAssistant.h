...
@property (nonatomic, readwrite) BOOL abortSetup;
@property (nonatomic, readonly) NSURL *actualStoreFileURL;
@property (nonatomic, readwrite) BOOL cacheFilePresenterForUbiquityRoot;
@property (nonatomic, readonly) PFUbiquityContainerIdentifier *containerIdentifier;
@property (nonatomic, readwrite) BOOL failSetup;
@property (nonatomic, readwrite, retain) NSError *failSetupError;
...
@property (nonatomic, readwrite) unsigned long long retryDelaySec;
@property (nonatomic, readonly) PFUbiquityKnowledgeVector *storeKV;
@property (nonatomic, readwrite) BOOL storeWasMigrated;
