...
@property (nonatomic, readwrite, retain) PFUbiquityKnowledgeVector *currentBaselineKV;
@property (nonatomic, readwrite, retain) PFUbiquityKnowledgeVector *currentKV;
@property (nonatomic, readonly) NSString *localPeerID;
@property (nonatomic, readonly) long long logSize;
@property (nonatomic, readwrite) long double logToStoreSizeRatio;
@property (nonatomic, readwrite) long long minLogBytes;
@property (nonatomic, readonly) NSString *modelVersionHash;
@property (nonatomic, readwrite) long long numRequiredTransactions;
