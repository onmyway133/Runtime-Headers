...
@property (atomic, readonly) NSEntityMapping *currentEntityMapping;
@property (atomic, readonly) NSManagedObjectContext *destinationContext;
@property (atomic, readonly) NSManagedObjectModel *destinationModel;
@property (atomic, readonly) NSMappingModel *mappingModel;
@property (atomic, readonly) float migrationProgress;
@property (atomic, readonly) NSManagedObjectContext *sourceContext;
@property (atomic, readonly) NSManagedObjectModel *sourceModel;
@property (nonatomic, readwrite, retain) NSDictionary *userInfo;
@property (atomic, readwrite) BOOL usesStoreSpecificMigrationManager;
...
// NSMigrationManager (InternalMethods)
