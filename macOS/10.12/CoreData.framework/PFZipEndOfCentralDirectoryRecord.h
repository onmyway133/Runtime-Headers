...
@property (nonatomic, readwrite) unsigned int byteSizeOfCentralDirectory;
@property (nonatomic, readwrite) unsigned int centralDirectoryOffset;
@property (nonatomic, readwrite, retain) NSString *comment;
@property (nonatomic, readonly) unsigned short commentLength;
@property (nonatomic, readwrite) unsigned short diskWhereCentralDirectoryStarts;
@property (nonatomic, readwrite) unsigned short numberOfCentralDirectoryRecordsOnThisDisk;
@property (nonatomic, readwrite) unsigned short numberOfDisk;
@property (nonatomic, readwrite) unsigned short totalNumberOfCentralDirectoryRecords;
