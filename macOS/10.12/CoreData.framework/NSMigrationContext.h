...
@property (atomic, readwrite, retain) NSEntityMapping *currentEntityMapping;
@property (atomic, readwrite) unsigned long long currentMigrationStep;
@property (atomic, readwrite, retain) NSPropertyMapping *currentPropertyMapping;
