...
@property (atomic, readonly) NSArray *persistentStores;
...
// NSPersistentStoreCoordinator (_NSPersistentStoreCoordinatorPrivateMathods)
...
// NSPersistentStoreCoordinator (_NSPersistentStoreCoordinatorPrivateMethodsForContacts)

- (int)_contactsIdentifierForObjectID:(id)arg1;
- (id)_objectIDForContactsIdentifier:(int)arg1 entityName:(id)arg2 store:(id)arg3;

// NSPersistentStoreCoordinator (_NSPersistentStoreCoordinatorPrivateMethodsForDuet)
