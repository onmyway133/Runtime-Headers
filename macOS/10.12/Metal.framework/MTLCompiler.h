...
@property (atomic, readonly) struct { unsigned char x1[32]; } cacheUUID;
@property (atomic, readwrite) struct MTLCompilerConnectionManager { int (**x1)(); }*compilerConnectionManager;
@property (atomic, readonly) unsigned long long compilerFlags;
@property (atomic, readwrite) unsigned int compilerId;
@property (atomic, readonly) NSObject<OS_dispatch_queue> *compilerQueue;
@property (atomic, readonly) struct MTLCompilerCache { unsigned int x1; int x2; struct fscache_attributes_s { unsigned long long x_3_1_1; unsigned short x_3_1_2; unsigned short x_3_1_3; unsigned int x_3_1_4; } x3; id x4; int x5; struct fscache_s {} *x6; }*functionCache;
