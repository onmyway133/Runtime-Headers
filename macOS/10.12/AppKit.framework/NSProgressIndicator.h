...
// NSProgressIndicator (NSIBProgressIndicatorIntegration)

- (id)ns_widgetType;

// NSProgressIndicator (NSProgressIndicatorAccessibility)
...
// NSProgressIndicator (NSProgressIndicatorDeprecated)
