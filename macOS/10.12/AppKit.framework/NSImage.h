...
@interface NSImage : NSObject <NSCoding, NSCopying, NSPasteboardReading, NSPasteboardWriting, NSSecureCoding> {
    struct __imageFlags { 
...
- (id)_addRepresentationWithSharedKitWindow:(long long)arg1 rect:(const struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg2;
