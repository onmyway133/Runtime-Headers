...
@property (atomic, readonly, copy) NSArray *availableFontFamilies;
@property (atomic, readonly, copy) NSArray *availableFonts;
@property (atomic, readonly, copy) NSArray *collectionNames;
@property (atomic, readonly) unsigned long long currentFontAction;
@property (atomic, readwrite) id delegate;
@property (getter=isEnabled, atomic, readwrite) BOOL enabled;
@property (getter=isMultiple, atomic, readonly) BOOL multiple;
@property (atomic, readonly) NSFont *selectedFont;
