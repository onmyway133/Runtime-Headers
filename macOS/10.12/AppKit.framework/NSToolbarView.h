...
- (void)_drawForTransitionInWindow:(id)arg1 usingPatternPhase:(struct CGSize { double x1; double x2; })arg2 inRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3;
- (BOOL)_drawsBaseline;
- (void)_enableLayout;
...
// NSToolbarView (NSToolbarViewAccessibility)
