...
@interface NSTextView : NSText <NSAccessibilityNavigableStaticText, NSDraggingSource, NSTextInput, NSTextInputClient, NSTextLayoutOrientationProvider, NSUserInterfaceValidations>
...
// NSTextView (NSTextView_RenderingAppearance)
