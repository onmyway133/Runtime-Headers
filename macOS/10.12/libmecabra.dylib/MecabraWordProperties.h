...
@property (nonatomic, readwrite, copy) NSString *analysisString;
@property (nonatomic, readwrite, retain) NSArray *characterInformation;
@property (nonatomic, readwrite, retain) NSArray *codeLookupInformation;
@property (getter=isEmoji, nonatomic, readwrite) BOOL emoji;
