...
@property (atomic, readonly) CIEnhancementHistogram *borderHist;
@property (atomic, readonly) CIEnhancementHistogram *lumHist;
@property (atomic, readonly) struct { double x1; double x2; } originalFaceColor;
@property (atomic, readonly) CIEnhancementHistogram *rgbSumHist;
@property (atomic, readonly) CIEnhancementHistogram *satHist;
