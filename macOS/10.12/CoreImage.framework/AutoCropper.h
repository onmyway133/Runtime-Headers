...
@property (nonatomic, readwrite) struct CGSize { double x1; double x2; } originalImageSize;
@property (nonatomic, readwrite) BOOL shouldFavorBottom;
@property (nonatomic, readwrite) BOOL shouldFavorTop;
