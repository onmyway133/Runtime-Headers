...
@property (atomic, readonly, retain) NSArray *filters;
@property (atomic, readonly) struct CGSize { double x1; double x2; } nativeSize;
@property (atomic, readonly, retain) NSDictionary *rawDictionary;
@property (atomic, readonly) int rawMajorVersion;
@property (atomic, readonly, retain) NSDictionary *rawReconstructionDefaultsDictionary;
@property (atomic, readonly) int subsampling;
@property (atomic, readonly, retain) NSNumber *sushiMode;
