...
@property (atomic, readonly) double I;
@property (atomic, readonly) double Q;
@property (atomic, readonly) int centerX;
@property (atomic, readonly) int centerY;
@property (atomic, readonly) int size;
