...
@property (nonatomic, readwrite, retain) CIVector *inputAVector;
@property (nonatomic, readwrite, retain) CIVector *inputBVector;
@property (nonatomic, readwrite, retain) CIVector *inputBiasVector;
@property (nonatomic, readwrite, retain) CIVector *inputGVector;
@property (nonatomic, readwrite, retain) CIImage *inputImage;
@property (nonatomic, readwrite, retain) CIVector *inputRVector;
