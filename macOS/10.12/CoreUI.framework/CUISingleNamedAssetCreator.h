...
@property (atomic, readwrite, retain) NSMutableArray *generators;
@property (atomic, readwrite, retain) NSMutableArray *names;
@property (atomic, readwrite) unsigned long long primaryIndex;
@property (atomic, readwrite, retain) NSString *primaryName;
@property (atomic, readwrite, retain) CUIMutableCommonAssetStorage *store;
