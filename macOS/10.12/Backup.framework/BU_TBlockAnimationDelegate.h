...
@interface BU_TBlockAnimationDelegate : NSObject <NSAnimationDelegate> {
    struct function<void (NSAnimation *, float)>="__buf_"{type="__lx"[24C] {}  _progressCallback;
}
...
- (id)init;
- (id)initWithAnimation:(id)arg1 progressCallback:(struct function<void (NSAnimation *, float)>={type=[24C] {})arg2;
