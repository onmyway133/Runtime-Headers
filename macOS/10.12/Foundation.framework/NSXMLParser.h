...
@property (atomic, readwrite, copy) NSSet *allowedExternalEntityURLs;
@property (atomic, readwrite) <NSXMLParserDelegate> *delegate;
@property (atomic, readwrite) unsigned long long externalEntityResolvingPolicy;
@property (atomic, readonly, copy) NSError *parserError;
@property (atomic, readwrite) BOOL shouldProcessNamespaces;
@property (atomic, readwrite) BOOL shouldReportNamespacePrefixes;
@property (atomic, readwrite) BOOL shouldResolveExternalEntities;
