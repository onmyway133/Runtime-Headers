...
@property (atomic, readwrite, retain) NSTextCheckingResult *dataDetectorResult;
@property (atomic, readwrite, retain) NSString *languageIdentifier;
@property (atomic, readonly) unsigned long long matchType;
@property (atomic, readonly) struct _NSRange { unsigned long long x1; unsigned long long x2; } range;
@property (atomic, readonly) double score;
