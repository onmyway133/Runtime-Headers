...
@property (atomic, readwrite) <NSISEngineDelegate> *delegate;
@property (atomic, readonly, copy) NSString *description;
@property (nonatomic, readwrite) struct CGSize { double x1; double x2; } engineScalingCoefficients;
@property (atomic, readonly) unsigned long long hash;
@property (atomic, readwrite, retain) NSISVariable *headForObjectiveRow;
@property (atomic, readwrite) struct __CFDictionary { }*integralizationAdjustmentsForConstraintMarkers;
@property (atomic, readwrite) BOOL revertsAfterUnsatisfiabilityHandler;
@property (atomic, readwrite, retain) NSMapTable *rows;
@property (atomic, readwrite, retain) NSMapTable *rowsCrossIndex;
@property (atomic, readwrite) BOOL shouldIntegralize;
@property (atomic, readonly) Class superclass;
@property (atomic, readonly) unsigned long long variableChangeCount;
@property (atomic, readwrite, retain) NSMutableSet *variablesWithIntegralizationViolations;
@property (atomic, readwrite, retain) NSMutableArray *variablesWithValueRestrictionViolations;
...
// NSISEngine (NSConstraintAmbiguityResolving)
