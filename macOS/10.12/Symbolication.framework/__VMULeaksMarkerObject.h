...
@property (nonatomic, readwrite) unsigned int entryIndex;
@property (nonatomic, readwrite) struct { unsigned long long x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned long long x8; }*region;
