...
@property (atomic, readonly) NSString *binaryName;
@property (atomic, readonly) NSString *binaryPath;
...
@property (atomic, readonly) NSString *fullIvarDescription;
@property (atomic, readonly) VMUClassInfo *genericInfo;
...
@property (atomic, readonly) NSString *shortIvarDescription;
@property (atomic, readonly) VMUClassInfo *superclassInfo;
