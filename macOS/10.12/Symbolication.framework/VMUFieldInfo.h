...
@property (atomic, readonly) VMUClassInfo *destinationLayout;
...
@property (atomic, readonly) NSString *ivarName;
@property (atomic, readonly) unsigned int offset;
@property (atomic, readonly) unsigned int scanType;
@property (atomic, readonly) unsigned int scannableSize;
@property (atomic, readonly) unsigned int size;
@property (atomic, readonly) unsigned int stride;
@property (atomic, readonly) NSArray *subFieldArray;
@property (atomic, readonly) NSString *typeName;
@property (atomic, readonly) NSString *typedDescription;
