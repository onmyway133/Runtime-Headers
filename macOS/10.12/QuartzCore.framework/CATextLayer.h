...
@property (atomic, readwrite, copy) NSString *alignmentMode;
@property (atomic, readwrite) BOOL allowsFontSubpixelQuantization;
@property (atomic, readwrite) const void*font;
@property (atomic, readwrite) double fontSize;
@property (atomic, readwrite) struct CGColor { }*foregroundColor;
@property (atomic, readwrite, copy) id string;
@property (getter=isTruncated, atomic, readonly) BOOL truncated;
@property (atomic, readwrite, copy) NSString *truncationMode;
@property (atomic, readwrite, copy) id truncationString;
@property (getter=isWrapped, atomic, readwrite) BOOL wrapped;
...
// CATextLayer (CATextLayerPrivate)
