...
@property (atomic, readwrite) unsigned int pluginFlags;
@property (atomic, readwrite, copy) NSString *pluginGravity;
@property (atomic, readwrite) unsigned long long pluginId;
@property (atomic, readwrite, copy) NSString *pluginType;
...
- (id)pluginType;
- (void)setPluginFlags:(unsigned int)arg1;
- (void)setPluginGravity:(id)arg1;
