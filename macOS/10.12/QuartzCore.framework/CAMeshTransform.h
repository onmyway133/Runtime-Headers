...
@property (atomic, readonly, copy) NSString *depthNormalization;
@property (atomic, readonly) unsigned long long faceCount;
@property (atomic, readonly) int subdivisionSteps;
@property (atomic, readonly) unsigned long long vertexCount;
