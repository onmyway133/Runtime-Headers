...
@property (atomic, readwrite, copy) NSString *basedOn;
@property (nonatomic, readwrite, copy) NSArray *elements;
@property (getter=isEnabled, atomic, readwrite) BOOL enabled;
@property (getter=isInitial, atomic, readwrite) BOOL initial;
@property (getter=isLocked, nonatomic, readwrite) BOOL locked;
@property (nonatomic, readwrite, copy) NSString *name;
@property (atomic, readwrite) double nextDelay;
@property (atomic, readwrite) double previousDelay;
