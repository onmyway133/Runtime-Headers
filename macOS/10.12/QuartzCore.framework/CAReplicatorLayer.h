...
@property (atomic, readwrite) float instanceAlphaOffset;
@property (atomic, readwrite) float instanceBlueOffset;
@property (atomic, readwrite) struct CGColor { }*instanceColor;
@property (atomic, readwrite) long long instanceCount;
@property (atomic, readwrite) double instanceDelay;
@property (atomic, readwrite) float instanceGreenOffset;
@property (atomic, readwrite) float instanceRedOffset;
@property (atomic, readwrite) struct CATransform3D { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; } instanceTransform;
