...
@property (atomic, readonly) unsigned long long currentDiskUsage;
@property (atomic, readonly) unsigned long long currentMemoryUsage;
@property (atomic, readwrite) unsigned long long diskCapacity;
@property (atomic, readwrite) unsigned long long memoryCapacity;
