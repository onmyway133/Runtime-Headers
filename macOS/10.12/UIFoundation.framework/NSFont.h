...
@property (atomic, readonly, copy) NSFont *printerFont;
@property (atomic, readonly) unsigned long long renderingMode;
@property (atomic, readonly, copy) NSFont *screenFont;
