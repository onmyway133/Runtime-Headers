...
@property (atomic, readwrite) NSAttributedString *attributedString;
@property (atomic, readonly, copy) NSDictionary *attributesForExtraLineFragment;
@property (atomic, readwrite) BOOL bidiProcessingEnabled;
@property (atomic, readonly, copy) NSParagraphStyle *currentParagraphStyle;
@property (atomic, readonly) NSTextContainer *currentTextContainer;
...
@property (atomic, readonly) struct _NSRange { unsigned long long x1; unsigned long long x2; } paragraphCharacterRange;
@property (atomic, readonly) struct _NSRange { unsigned long long x1; unsigned long long x2; } paragraphGlyphRange;
@property (atomic, readonly) struct _NSRange { unsigned long long x1; unsigned long long x2; } paragraphSeparatorCharacterRange;
@property (atomic, readonly) struct _NSRange { unsigned long long x1; unsigned long long x2; } paragraphSeparatorGlyphRange;
...
+ (void)initialize;
+ (struct CGSize { double x1; double x2; })printingAdjustmentInLayoutManager:(id)arg1 forNominallySpacedGlyphRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 packedGlyphs:(const char *)arg3 count:(unsigned long long)arg4;
