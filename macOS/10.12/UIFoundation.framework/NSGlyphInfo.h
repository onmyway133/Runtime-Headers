...
@property (atomic, readonly) unsigned long long characterCollection;
@property (atomic, readonly) unsigned long long characterIdentifier;
@property (atomic, readonly, copy) NSString *glyphName;
