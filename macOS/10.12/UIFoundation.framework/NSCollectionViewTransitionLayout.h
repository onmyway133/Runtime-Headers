...
@property (atomic, readonly) NSCollectionViewLayout *currentLayout;
@property (atomic, readonly) NSCollectionViewLayout *nextLayout;
@property (atomic, readwrite) double transitionProgress;
