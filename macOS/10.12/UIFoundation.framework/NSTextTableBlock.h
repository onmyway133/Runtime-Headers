...
@property (atomic, readonly) long long columnSpan;
@property (atomic, readonly) long long rowSpan;
@property (atomic, readonly) long long startingColumn;
@property (atomic, readonly) long long startingRow;
@property (atomic, readonly) NSTextTable *table;
